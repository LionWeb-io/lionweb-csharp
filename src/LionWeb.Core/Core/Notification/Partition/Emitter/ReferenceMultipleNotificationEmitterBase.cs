...
{
    protected readonly List<IReferenceDescriptor> SafeNodes;

    protected ReferenceMultipleNotificationEmitterBase(Reference reference, INotifiableNode destinationParent, List<IReferenceDescriptor> safeNodes,

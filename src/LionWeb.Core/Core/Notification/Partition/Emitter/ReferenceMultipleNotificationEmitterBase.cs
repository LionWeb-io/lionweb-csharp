...
{
    protected readonly List<ReferenceDescriptor> SafeNodes;

    protected ReferenceMultipleNotificationEmitterBase(Reference reference, INotifiableNode destinationParent, List<ReferenceDescriptor> safeNodes,

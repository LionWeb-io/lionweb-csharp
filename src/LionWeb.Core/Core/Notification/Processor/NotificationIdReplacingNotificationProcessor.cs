...
public class NotificationIdReplacingNotificationProcessor<TNotification>(object? sender)
    : FilteringNotificationProcessor<TNotification>(sender) where TNotification : class, INotification
{

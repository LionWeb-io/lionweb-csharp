...
internal sealed class Version2025_1_Compatible : VersionBase<IBuiltInsLanguage_2025_1, ILionCoreLanguage_2025_1>,
    IVersion2025_1_Compatible
{
    internal static readonly Version2025_1_Compatible Instance = new Lazy<Version2025_1_Compatible>(() => new()).Value;
    private Version2025_1_Compatible() { }
    ...
    public override bool IsCompatibleWithInternal(LionWebVersions other) =>
        ...
        ReferenceEquals(other, LionWebVersions.v2025_1);
}
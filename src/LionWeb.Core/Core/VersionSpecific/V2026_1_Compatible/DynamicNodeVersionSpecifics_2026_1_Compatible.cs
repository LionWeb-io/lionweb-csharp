...
/// <see cref="DynamicNode"/> parts specific to LionWeb <see cref="IVersion2026_1_Compatible"/>.  
internal class DynamicNodeVersionSpecifics_2026_1_Compatible : DynamicNodeVersionSpecificsBase
{
    ...
    public override object PrepareSetProperty(Property property, object? value)
    {
        switch (value)
        {
            ...
            case string when property.Type.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.String):
            case int when property.Type.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.Integer):
            case bool when property.Type.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.Boolean):
                return value;

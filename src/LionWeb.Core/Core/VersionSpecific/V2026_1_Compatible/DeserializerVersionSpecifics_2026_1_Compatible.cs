...
/// <see cref="IDeserializer"/> parts specific to LionWeb <see cref="IVersion2026_1_Compatible"/>.  
internal class DeserializerVersionSpecifics_2026_1_Compatible<T, H>(
    DeserializerBase<T, H> deserializer,
    DeserializerMetaInfo metaInfo,
    IDeserializerHandler handler)
    : DeserializerVersionSpecifics_2026_1<T, H>(deserializer, metaInfo, handler)
    where T : class, IReadableNode where H : class, IDeserializerHandler
{
        ...
        PropertyValue value)
    {
        ...
        return datatype switch
        {
            var b when
                ...
                BuiltInsLanguage_2026_1.Instance.Boolean.EqualsIdentity(b)
                =>
            ...
            var s when
                ...
                BuiltInsLanguage_2026_1.Instance.String.EqualsIdentity(s) =>
                value,
    ...
    public override void RegisterBuiltins()
    {
        ...
        RegisterLanguage(BuiltInsLanguage_2026_1.Instance);
    }
}
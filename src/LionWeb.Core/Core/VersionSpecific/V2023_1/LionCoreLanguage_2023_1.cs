...
public sealed class LionCoreFactory_2023_1 : INodeFactory
{
    ...
    /// <inheritdoc cref="M3.Annotation"/>
    public DynamicAnnotation Annotation(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.Concept"/>
    public DynamicConcept Concept(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.Containment"/>
    public DynamicContainment Containment(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.Enumeration"/>
    public DynamicEnumeration Enumeration(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.EnumerationLiteral"/>
    public DynamicEnumerationLiteral EnumerationLiteral(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.Interface"/>
    public DynamicInterface Interface(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.Language"/>
    public DynamicLanguage Language(NodeId id) => new(id, _language.LionWebVersion);

    /// <inheritdoc cref="M3.PrimitiveType"/>
    public DynamicPrimitiveType PrimitiveType(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.Property"/>
    public DynamicProperty Property(NodeId id) => new(id, LionWebVersions.v2023_1, null);

    /// <inheritdoc cref="M3.Reference"/>
    public DynamicReference Reference(NodeId id) => new(id, LionWebVersions.v2023_1, null);

...
public sealed class LionCoreLanguage_2024_1 : LanguageBase<LionCoreFactory_2024_1>, ILionCoreLanguage_2024_1
{
    ...
    private const string _idPrefix = "-id-2024_1";
    ...
    internal LionCoreLanguage_2024_1() : base($"{_idPrefix}-LionCore-M3", LionWebVersions.v2024_1)
    {
...
public sealed class LionCoreFactory_2024_1 : INodeFactory
{
    ...
    /// <inheritdoc cref="LionWeb.Core.M3.Annotation"/>
    public DynamicAnnotation Annotation(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Concept"/>
    public DynamicConcept Concept(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Containment"/>
    public DynamicContainment Containment(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Enumeration"/>
    public DynamicEnumeration Enumeration(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.EnumerationLiteral"/>
    public DynamicEnumerationLiteral EnumerationLiteral(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Field"/>
    public DynamicField Field(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Interface"/>
    public DynamicInterface Interface(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Language"/>
    public DynamicLanguage Language(NodeId id) => new(id, _language.LionWebVersion);

    /// <inheritdoc cref="LionWeb.Core.M3.PrimitiveType"/>
    public DynamicPrimitiveType PrimitiveType(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Property"/>
    public DynamicProperty Property(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Reference"/>
    public DynamicReference Reference(NodeId id) => new(id, LionWebVersions.v2024_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.StructuredDataType"/>
    public DynamicStructuredDataType StructuredDataType(NodeId id) => new(id, LionWebVersions.v2024_1, null);

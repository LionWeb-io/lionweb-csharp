...
/// <see cref="DynamicNode"/> parts specific to LionWeb <see cref="IVersion2025_1"/>.  
internal class DynamicNodeVersionSpecifics_2025_1 : DynamicNodeVersionSpecificsBase
{

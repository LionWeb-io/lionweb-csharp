...
/// The self-definition of the LionCore <see cref="IVersion2025_1"/> M3.
public interface ILionCoreLanguage_2025_1 : ILionCoreLanguageWithStructuredDataType;

/// <inheritdoc cref="ILionCoreLanguage"/>
public sealed class LionCoreLanguage_2025_1 : LanguageBase<LionCoreFactory_2025_1>, ILionCoreLanguage_2025_1
{
    /// The definition of the LionCore <see cref="IVersion2025_1"/> M3 language.
    public static readonly ILionCoreLanguage_2025_1 Instance = new Lazy<LionCoreLanguage_2025_1>(() => new()).Value;

    private const string _idPrefix = "-id-2025_1";

    /// <inheritdoc />
    protected override IBuiltInsLanguage_2025_1 _builtIns => BuiltInsLanguage_2025_1.Instance;

    /// <inheritdoc />
    protected override ILionCoreLanguage_2025_1 _m3 => this;

    internal LionCoreLanguage_2025_1() : base($"{_idPrefix}-LionCore-M3", LionWebVersions.v2025_1)
    {
        ...
        _concept_abstract = new(() => new M3Property($"{_idPrefix}-Concept-abstract", Concept, this)
        {
            ...
            Name = "abstract",
            Optional = false,
            Type = BuiltInsLanguage_2025_1.Instance.Boolean
        });
        ...
        _iKeyed = new(() =>
            new M3Interface($"{_idPrefix}-IKeyed", this)
            {
                Key = "IKeyed",
                Name = "IKeyed",
                ExtendsLazy = new(() => [BuiltInsLanguage_2025_1.Instance.INamed]),
                FeaturesLazy = new(() => [IKeyed_key])
            });
        _iKeyed_key = new(() => new M3Property($"{_idPrefix}-IKeyed-key", IKeyed, this)
        {
            Key = "IKeyed-key", Name = "key", Optional = false, Type = BuiltInsLanguage_2025_1.Instance.String
        });
        ...
        _language_version = new(() => new M3Property($"{_idPrefix}-Language-version", Language, this)
        {
            ...
            Name = "version",
            Optional = false,
            Type = BuiltInsLanguage_2025_1.Instance.String
        });
    ...
    /// <inheritdoc />
    public override IReadOnlyList<Language> DependsOn { get; } = [BuiltInsLanguage_2025_1.Instance];

    /// <inheritdoc />
    public override LionCoreFactory_2025_1 GetFactory() => new(this);
...
/// <inheritdoc />
public sealed class LionCoreFactory_2025_1 : INodeFactory
{
    private readonly ILionCoreLanguage_2025_1 _language;

    internal LionCoreFactory_2025_1(ILionCoreLanguage_2025_1 language)
    {
        _language = language;
    }

    /// <inheritdoc cref="LionWeb.Core.M3.Annotation"/>
    public DynamicAnnotation Annotation(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Concept"/>
    public DynamicConcept Concept(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Containment"/>
    public DynamicContainment Containment(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Enumeration"/>
    public DynamicEnumeration Enumeration(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.EnumerationLiteral"/>
    public DynamicEnumerationLiteral EnumerationLiteral(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Field"/>
    public DynamicField Field(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Interface"/>
    public DynamicInterface Interface(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Language"/>
    public DynamicLanguage Language(string id) => new(id, _language.LionWebVersion);

    /// <inheritdoc cref="LionWeb.Core.M3.PrimitiveType"/>
    public DynamicPrimitiveType PrimitiveType(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Property"/>
    public DynamicProperty Property(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.Reference"/>
    public DynamicReference Reference(string id) => new(id, LionWebVersions.v2025_1, null);

    /// <inheritdoc cref="LionWeb.Core.M3.StructuredDataType"/>
    public DynamicStructuredDataType StructuredDataType(string id) => new(id, LionWebVersions.v2025_1, null);

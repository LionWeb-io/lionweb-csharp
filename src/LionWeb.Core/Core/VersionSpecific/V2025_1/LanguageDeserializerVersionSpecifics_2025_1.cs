...
/// <see cref="LanguageDeserializer"/> parts specific to LionWeb <see cref="IVersion2025_1"/>.  
internal class LanguageDeserializerVersionSpecifics_2025_1(
    ...
    : LanguageDeserializerVersionSpecificsBase(deserializer, handler)
{
    ...
    public override DynamicIKeyed CreateNodeWithProperties(SerializedNode serializedNode, NodeId id) =>
        new NodeCreator_2025_1(this, serializedNode, id).Create();
    ...
    public override void InstallLanguageContainments(SerializedNode serializedNode, IReadableNode node,
        ...
        new ContainmentsInstaller_2025_1(this, serializedNode, node, serializedContainmentsLookup).Install();
    ...
    public override void InstallLanguageReferences(SerializedNode serializedNode, IReadableNode node,
        ...
        new ReferencesInstaller_2025_1(this, serializedNode, node, serializedReferencesLookup).Install();
...
internal class NodeCreator_2025_1(
    LanguageDeserializerVersionSpecifics_2025_1 versionSpecifics,
    SerializedNode serializedNode,
    NodeId id)
    : NodeCreatorBase(versionSpecifics, serializedNode, id)
{
    protected override LionWebVersions Version => LionWebVersions.v2025_1;
    protected override ILionCoreLanguageWithStructuredDataType LionCore => (ILionCoreLanguage_2025_1)Version.LionCore;

    public override DynamicIKeyed Create() => _serializedNode.Classifier switch
    {
        var s when s.Key == LionCore.StructuredDataType.Key => new DynamicStructuredDataType(_id, LionWebVersions.v2025_1, null)
        {
            Key = _key, Name = _name
        },
        var s when s.Key == LionCore.Field.Key => new DynamicField(_id, LionWebVersions.v2025_1, null) { Key = _key, Name = _name },
        _ => base.Create()
    };
}

internal class ContainmentsInstaller_2025_1(
    ...
    public override void Install()
    {
        switch (_node)
        {
            case DynamicStructuredDataType sdt:
                ...
                if (LanguageDeserializerVersionSpecifics_2025_1.ContainsSelf(sdt, owners))
...
internal class ReferencesInstaller_2025_1(
    LanguageDeserializerVersionSpecificsBase versionSpecifics,
    SerializedNode serializedNode,
    IReadableNode node,
    ILookup<MetaPointerKey, IKeyed?> serializedReferencesLookup)
    ...
    public override void Install()
    {
        switch (_node)
        {
            case DynamicField field:
                ...
                if (LanguageDeserializerVersionSpecifics_2025_1.ContainsSelf(fSdt, fOwners))

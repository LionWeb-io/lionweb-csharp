...
public static class JsonUtils
{
    ...
    public static async Task<List<IReadableNode>> ReadNodesFromStreamAsync(Stream stream, IDeserializer deserializer, Action<string>? lionWebVersionChecker = null)
    {

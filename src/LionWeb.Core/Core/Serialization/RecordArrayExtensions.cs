...
/// Helpers to properly deal with arrays in records
public static class RecordArrayExtensions
{
    ...
    /// Appends <paramref name="arr"/> to <paramref name="builder"/>.

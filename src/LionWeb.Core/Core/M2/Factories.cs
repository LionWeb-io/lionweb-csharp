...
public interface INodeFactory
{
    ...
    public INode CreateNode(PropertyValue id, Classifier classifier);
...
public class ReflectiveBaseNodeFactory(Language language) : AbstractBaseNodeFactory(language)
{
    ...
    {
        var constructorInfo = typeof(LionCoreMetaPointer).GetConstructor([typeof(Type), typeof(MetaPointerKey)]);

...
internal interface ILanguageDeserializerVersionSpecifics : IVersionSpecifics
{
    ...
    public static ILanguageDeserializerVersionSpecifics Create(LionWebVersions lionWebVersion,
        ...
        => lionWebVersion switch
        {
            ...
            IVersion2026_1 => new LanguageDeserializerVersionSpecifics_2026_1(deserializer, handler),
            IVersion2026_1_Compatible =>
                new LanguageDeserializerVersionSpecifics_2026_1_Compatible(deserializer, handler),

...
public class DeserializerExceptionHandler : IDeserializerHandler
{
    ...
    /// <inheritdoc />
    public virtual NodeId? DuplicateNodeId(CompressedId nodeId, IReadableNode existingNode, IReadableNode node) =>
    ...
    /// <inheritdoc />
    public virtual object? InvalidPropertyValue<TValue>(PropertyValue? value, Feature property, CompressedId nodeId) =>
        throw new DeserializerException(

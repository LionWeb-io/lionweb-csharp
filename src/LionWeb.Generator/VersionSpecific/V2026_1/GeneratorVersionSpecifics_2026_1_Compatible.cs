...
namespace LionWeb.Generator.VersionSpecific.V2026_1;
...
using Core.VersionSpecific.V2026_1;
using Microsoft.CodeAnalysis.CSharp;
using Microsoft.CodeAnalysis.CSharp.Syntax;
using static Microsoft.CodeAnalysis.CSharp.SyntaxFactory;

/// <see cref="GeneratorFacade"/> parts specific to LionWeb <see cref="IVersion2026_1_Compatible"/>.  
internal class GeneratorVersionSpecifics_2026_1_Compatible : GeneratorVersionSpecifics_2026_1
{
    public override LionWebVersions Version => LionWebVersions.v2026_1_Compatible;
    ...
    public override ExpressionSyntax? AsProperty(LanguageEntity entity) => entity switch
    {
        ...
        _ when entity.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.Node) => ParseExpression("_builtIns.Node"),
        _ when entity.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.INamed) => ParseExpression("_builtIns.INamed"),
        _ when entity.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.Boolean) => ParseExpression("_builtIns.Boolean"),
        _ when entity.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.Integer) => ParseExpression("_builtIns.Integer"),
        _ when entity.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.String) => ParseExpression("_builtIns.String"),
        _ when entity.EqualsIdentity(LionCoreLanguage_2026_1.Instance.IKeyed) => ParseExpression("_m3.IKeyed"),
        _ when entity.EqualsIdentity(LionCoreLanguage_2026_1.Instance.Classifier) => ParseExpression("_m3.Classifier"),
        _ when entity.EqualsIdentity(LionCoreLanguage_2026_1.Instance.Concept) => ParseExpression("_m3.Concept"),
        _ when entity.EqualsIdentity(LionCoreLanguage_2026_1.Instance.Annotation) => ParseExpression("_m3.Annotation"),
        _ when entity.EqualsIdentity(LionCoreLanguage_2026_1.Instance.Interface) => ParseExpression("_m3.Interface"),
        _ => null
    };
    ...
    public override TypeSyntax? AsType(Datatype datatype, Dictionary<Language, string> namespaceMappings) => datatype switch
    {
        ...
        _ when datatype.EqualsIdentity(BuiltInsLanguage_2023_1.Instance.Json) =>
            PredefinedType(Token(SyntaxKind.StringKeyword)),
        _ when datatype.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.Boolean) =>
            PredefinedType(Token(SyntaxKind.BoolKeyword)),
        _ when datatype.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.Integer) =>
            PredefinedType(Token(SyntaxKind.IntKeyword)),
        _ when datatype.EqualsIdentity(BuiltInsLanguage_2026_1.Instance.String) =>
            PredefinedType(Token(SyntaxKind.StringKeyword)),

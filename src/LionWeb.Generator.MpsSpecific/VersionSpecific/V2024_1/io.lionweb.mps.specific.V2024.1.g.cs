...
public partial class KeyedDescription : AnnotationInstanceBase
{
	...
	private readonly List<INode> _seeAlso = [];
	...
	public IReadOnlyList<INode> SeeAlso { get => _seeAlso.AsReadOnly(); init => AddSeeAlso(value); }
	...
	/// <remarks>Optional Multiple Reference</remarks>
        public KeyedDescription AddSeeAlso(IEnumerable<INode> nodes)
	{
	...
	/// <remarks>Optional Multiple Reference</remarks>
        public KeyedDescription InsertSeeAlso(int index, IEnumerable<INode> nodes)
	{
	...
	/// <remarks>Optional Multiple Reference</remarks>
        public KeyedDescription RemoveSeeAlso(IEnumerable<INode> nodes)
	{
		var safeNodes = nodes?.ToList();
		AssureNotNull(safeNodes, SpecificLanguage.Instance.KeyedDescription_seeAlso);
		AssureNotNullMembers(safeNodes, SpecificLanguage.Instance.KeyedDescription_seeAlso);
		RemoveAll(safeNodes, _seeAlso, ReferenceRemover<INode>(SpecificLanguage.Instance.KeyedDescription_seeAlso));
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (SpecificLanguage.Instance.KeyedDescription_seeAlso.EqualsIdentity(feature))
		{
			var enumerable = SpecificLanguage.Instance.KeyedDescription_seeAlso.AsNodes<INode>(value);
			_seeAlso.Clear();

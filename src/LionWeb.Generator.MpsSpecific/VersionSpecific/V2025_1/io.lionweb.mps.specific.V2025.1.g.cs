...
[LionCoreLanguage(Key = "io-lionweb-mps-specific", Version = "2025.1")]
public partial class SpecificLanguage : LanguageBase<ISpecificFactory>, ISpecificLanguage
{
	...
	public SpecificLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
	...
	private const string _version = "2025.1";
	/// <inheritdoc/>

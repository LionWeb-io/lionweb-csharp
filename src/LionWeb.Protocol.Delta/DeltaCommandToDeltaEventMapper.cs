...
public class DeltaCommandToDeltaEventMapper
{
    ...
    public IDeltaEvent Map(IDeltaCommand deltaCommand)
    {
        IDeltaEvent result = deltaCommand switch
        {
            ...
            MoveAndReplaceChildFromContainmentInOtherParent a => new ChildMovedAndReplacedFromOtherContainment(a.NewParent, a.NewContainment, a.NewIndex, a.MovedChild, GetParent(a.MovedChild), GetContainment(a.MovedChild), GetIndex(a.MovedChild), a.ReplacedChild, [], OriginCommands(a), []),

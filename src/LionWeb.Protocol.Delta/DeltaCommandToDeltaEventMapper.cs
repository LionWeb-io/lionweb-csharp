...
public class DeltaCommandToDeltaEventMapper
{
    ...
    public IEvent Map(ICommand deltaCommand) =>
        deltaCommand switch
        {
            ...
            ReplaceAnnotationCommand a => new AnnotationReplaced(a.NewAnnotation,a.ReplacedAnnotation, [], a.Parent, a.Index, OriginCommands(a), []),
    ...
    private CommandSource[] OriginCommands(ICommand a) =>

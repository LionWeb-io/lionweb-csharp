...
public class DeltaCommandToDeltaEventMapper
{
    ...
    public IDeltaEvent Map(IDeltaCommand deltaCommand) =>
        deltaCommand switch
        {
            ...
            AddChild a => new ChildAdded(a.Parent, a.NewChild, a.Containment, a.Index, a.Split, OriginCommands(a), []),
            DeleteChild a => new ChildDeleted(a.DeletedChild, [], a.Parent, a.Containment, a.Index, OriginCommands(a), []),
            ReplaceChild a => new ChildReplaced(a.NewChild, a.ReplacedChild, [], a.Parent, a.Containment, a.Index , a.Split, OriginCommands(a), []),
            ...
            AddAnnotation a => new AnnotationAdded(a.Parent, a.NewAnnotation, a.Index, a.Split, OriginCommands(a), []),
            DeleteAnnotation a => new AnnotationDeleted(a.DeletedAnnotation, [], a.Parent, a.Index, OriginCommands(a), []),
            ReplaceAnnotation a => new AnnotationReplaced(a.NewAnnotation,a.ReplacedAnnotation, [], a.Parent, a.Index, a.Split, OriginCommands(a), []),

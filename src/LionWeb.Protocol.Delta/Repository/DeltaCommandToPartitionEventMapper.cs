...
public class DeltaCommandToPartitionEventMapper
{
    ...
    public IPartitionNotification Map(IDeltaCommand command) =>
        command switch
        {
            ...
            AddReferenceCommand a => OnAddReference(a),
    ...
    private PropertyAddedNotification OnAddProperty(AddPropertyCommand addPropertyEvent)
    {
    ...
    private ChildAddedNotification OnAddChild(AddChildCommand command)
    {
    ...
    private ReferenceAddedNotification OnAddReference(AddReferenceCommand addReferenceEvent)
    {

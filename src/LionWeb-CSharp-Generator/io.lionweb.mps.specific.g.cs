...
public class SpecificLanguage : LanguageBase<SpecificFactory>
{
	...
	/// <inheritdoc/>
        public override IReadOnlyList<LanguageEntity> Entities => [ConceptDescription, ShortDescription, VirtualPackage];
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [];

	/// <inheritdoc/>
        public override SpecificFactory GetFactory() => new(this);
...
public class SpecificFactory : AbstractBaseNodeFactory
{
	...
	public ConceptDescription NewConceptDescription(string id) => new(id);
	public ConceptDescription CreateConceptDescription() => NewConceptDescription(GetNewId());
	public ShortDescription NewShortDescription(string id) => new(id);
	public ShortDescription CreateShortDescription() => NewShortDescription(GetNewId());
	public VirtualPackage NewVirtualPackage(string id) => new(id);
	public VirtualPackage CreateVirtualPackage() => NewVirtualPackage(GetNewId());
}

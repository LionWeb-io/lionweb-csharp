...
public static class M2Extensions
{
    ...
    /// <seealso cref="DirectGeneralizations(LionWeb.Core.M3.Annotation)"/>
    /// <seealso cref="DirectGeneralizations(LionWeb.Core.M3.Concept)"/>
    /// <seealso cref="DirectGeneralizations(LionWeb.Core.M3.Interface)"/>

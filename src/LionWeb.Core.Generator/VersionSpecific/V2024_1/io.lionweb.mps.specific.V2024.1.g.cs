...
public partial class SpecificLanguage : LanguageBase<ISpecificFactory>, ISpecificLanguage
{
	...
	{
		_conceptDescription = new(() => new AnnotationBase<SpecificLanguage>("ConceptDescription", this) { Key = "ConceptDescription", Name = "ConceptDescription", AnnotatesLazy = new(() => LionCoreLanguage_2024_1.Instance.Classifier), FeaturesLazy = new(() => [ConceptDescription_conceptAlias, ConceptDescription_conceptShortDescription]) });
		_conceptDescription_conceptAlias = new(() => new PropertyBase<SpecificLanguage>("ConceptDescription-conceptAlias", ConceptDescription, this) { Key = "ConceptDescription-conceptAlias", Name = "conceptAlias", Optional = true, Type = BuiltInsLanguage_2024_1.Instance.String });
		_conceptDescription_conceptShortDescription = new(() => new PropertyBase<SpecificLanguage>("ConceptDescription-conceptShortDescription", ConceptDescription, this) { Key = "ConceptDescription-conceptShortDescription", Name = "conceptShortDescription", Optional = true, Type = BuiltInsLanguage_2024_1.Instance.String });
		_deprecated = new(() => new AnnotationBase<SpecificLanguage>("Deprecated", this) { Key = "Deprecated", Name = "Deprecated", AnnotatesLazy = new(() => LionCoreLanguage_2024_1.Instance.IKeyed), FeaturesLazy = new(() => [Deprecated_build, Deprecated_comment]) });
		_deprecated_build = new(() => new PropertyBase<SpecificLanguage>("Deprecated-build", Deprecated, this) { Key = "Deprecated-build", Name = "build", Optional = true, Type = BuiltInsLanguage_2024_1.Instance.String });
		_deprecated_comment = new(() => new PropertyBase<SpecificLanguage>("Deprecated-comment", Deprecated, this) { Key = "Deprecated-comment", Name = "comment", Optional = true, Type = BuiltInsLanguage_2024_1.Instance.String });
		_shortDescription = new(() => new AnnotationBase<SpecificLanguage>("ShortDescription", this) { Key = "ShortDescription", Name = "ShortDescription", AnnotatesLazy = new(() => BuiltInsLanguage_2024_1.Instance.Node), FeaturesLazy = new(() => [ShortDescription_description]) });
		_shortDescription_description = new(() => new PropertyBase<SpecificLanguage>("ShortDescription-description", ShortDescription, this) { Key = "ShortDescription-description", Name = "description", Optional = true, Type = BuiltInsLanguage_2024_1.Instance.String });
		_virtualPackage = new(() => new AnnotationBase<SpecificLanguage>("VirtualPackage", this) { Key = "VirtualPackage", Name = "VirtualPackage", AnnotatesLazy = new(() => BuiltInsLanguage_2024_1.Instance.Node), ImplementsLazy = new(() => [BuiltInsLanguage_2024_1.Instance.INamed]) });
...
public partial class VirtualPackage : NodeBase, INamedWritable
{
	...
	/// <remarks>Required Property</remarks>
        ...
        [LionCoreMetaPointer(Language = typeof(BuiltInsLanguage_2024_1), Key = "LionCore-builtins-INamed-name")]
	[LionCoreFeature(Kind = LionCoreFeatureKind.Property, Optional = false, Multiple = false)]
	public string Name { get => _name ?? throw new UnsetFeatureException(BuiltInsLanguage_2024_1.Instance.INamed_name); set => SetName(value); }
/// <remarks>Required Property</remarks>
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value) => SetName(value);
	...
	{
		AssureNotNull(value, BuiltInsLanguage_2024_1.Instance.INamed_name);
		_name = value;
		return this;
	}
        ...
        protected override bool GetInternal(Feature? feature, out Object? result)
	{
		if (base.GetInternal(feature, out result))
			return true;
		if (BuiltInsLanguage_2024_1.Instance.INamed_name.EqualsIdentity(feature))
		{
			result = Name;
			return true;
		}
        ...
        public override IEnumerable<Feature> CollectAllSetFeatures()
	{
		var result = base.CollectAllSetFeatures().ToList();
		if (_name != default)
			result.Add(BuiltInsLanguage_2024_1.Instance.INamed_name);
		return result;
	}
}
...
#nullable enable
namespace Examples.V2023_1.Shapes.M2;
using LionWeb.Core;
...
public partial class BillOfMaterials : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.BillOfMaterials_altGroups.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.BillOfMaterials_altGroups.AsNodes<Examples.V2023_1.Shapes.M2.MaterialGroup>(value);
		...
		if (ShapesLanguage.Instance.BillOfMaterials_defaultGroup.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.MaterialGroup)
			{
				DefaultGroup = (Examples.V2023_1.Shapes.M2.MaterialGroup?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.BillOfMaterials_groups.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.BillOfMaterials_groups.AsNodes<Examples.V2023_1.Shapes.M2.MaterialGroup>(value);
		...
		if (ShapesLanguage.Instance.BillOfMaterials_materials.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.BillOfMaterials_materials.AsNodes<Examples.V2023_1.Shapes.M2.IShape>(value);
			_materials.Clear();
...
public partial class Circle : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.Circle_center.EqualsIdentity(feature))
		{
			if (value is Examples.V2023_1.Shapes.M2.Coord v)
			{
				Center = v;
				return true;
			}
...
public partial class CompositeShape : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.CompositeShape_disabledParts.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.CompositeShape_disabledParts.AsNodes<Examples.V2023_1.Shapes.M2.IShape>(value).ToList();
		...
		if (ShapesLanguage.Instance.CompositeShape_evilPart.EqualsIdentity(feature))
		{
			if (value is Examples.V2023_1.Shapes.M2.IShape v)
			{
				EvilPart = v;
				return true;
			}
		...
		if (ShapesLanguage.Instance.CompositeShape_parts.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.CompositeShape_parts.AsNodes<Examples.V2023_1.Shapes.M2.IShape>(value).ToList();
...
public partial class Geometry : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.Geometry_documentation.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.Documentation)
			{
				Documentation = (Examples.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.Geometry_shapes.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.Geometry_shapes.AsNodes<Examples.V2023_1.Shapes.M2.IShape>(value);
...
public partial class MaterialGroup : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.MaterialGroup_defaultShape.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.IShape)
			{
				DefaultShape = (Examples.V2023_1.Shapes.M2.IShape?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.MaterialGroup_materials.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.MaterialGroup_materials.AsNodes<Examples.V2023_1.Shapes.M2.IShape>(value).ToList();
		...
		if (ShapesLanguage.Instance.MaterialGroup_matterState.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.MatterState)
			{
				MatterState = (Examples.V2023_1.Shapes.M2.MatterState?)value;
				return true;
			}
...
public partial class OffsetDuplicate : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_altSource.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.Shape)
			{
				AltSource = (Examples.V2023_1.Shapes.M2.Shape?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_docs.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.Documentation)
			{
				Docs = (Examples.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_secretDocs.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.Documentation)
			{
				SecretDocs = (Examples.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_source.EqualsIdentity(feature))
		{
			if (value is Examples.V2023_1.Shapes.M2.Shape v)
			{
				Source = v;
				return true;
			}
...
public partial class ReferenceGeometry : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.ReferenceGeometry_shapes.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.ReferenceGeometry_shapes.AsNodes<Examples.V2023_1.Shapes.M2.IShape>(value);
			_shapes.Clear();
			AddShapes(enumerable);
			return true;
		}
...
/// <exception cref="InvalidValueException">If set to null</exception>
 IShape IShape.SetUuid(string value) => SetUuid(value);
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.IShape_fixpoints.EqualsIdentity(feature))
		{
			var enumerable = ShapesLanguage.Instance.IShape_fixpoints.AsNodes<Examples.V2023_1.Shapes.M2.Coord>(value);
		...
		if (ShapesLanguage.Instance.Shape_shapeDocs.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Shapes.M2.Documentation)
			{
				ShapeDocs = (Examples.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}

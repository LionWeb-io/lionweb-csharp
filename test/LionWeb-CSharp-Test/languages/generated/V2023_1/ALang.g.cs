...
#nullable enable
namespace Examples.V2023_1.Circular.A;
using LionWeb.Core;
...
public partial class ALangLanguage : LanguageBase<IALangFactory>
{
	...
	public ALangLanguage(string id) : base(id, LionWebVersions.v2023_1)
	{
		...
		_aConcept_BRef = new(() => new ReferenceBase<ALangLanguage>("id-AConcept-BRef", AConcept, this) { Key = "key-BRef", Name = "BRef", Optional = true, Multiple = false, Type = Examples.V2023_1.Circular.B.BLangLanguage.Instance.BConcept });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [Examples.V2023_1.Circular.B.BLangLanguage.Instance];
...
{
	private Examples.V2023_1.Circular.B.BConcept? _bRef = null;
	...
	public Examples.V2023_1.Circular.B.BConcept? BRef { get => _bRef; set => SetBRef(value); }

	/// <remarks>Optional Single Reference</remarks>
        public AConcept SetBRef(Examples.V2023_1.Circular.B.BConcept? value)
	{
		_bRef = value;
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ALangLanguage.Instance.AConcept_BRef.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2023_1.Circular.B.BConcept)
			{
				BRef = (Examples.V2023_1.Circular.B.BConcept?)value;
				return true;
			}

...
#nullable enable
namespace Examples.V2024_1.Library.M2;
using LionWeb.Core;
...
public partial class Book : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (LibraryLanguage.Instance.Book_author.EqualsIdentity(feature))
		{
			if (value is Examples.V2024_1.Library.M2.Writer v)
			{
				Author = v;
				return true;
			}
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2024_1.Library.M2.BookType)
			{
				Type = (Examples.V2024_1.Library.M2.BookType?)value;
				return true;
			}
...
public partial class Library : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(feature))
		{
			var enumerable = LibraryLanguage.Instance.Library_books.AsNodes<Examples.V2024_1.Library.M2.Book>(value).ToList();

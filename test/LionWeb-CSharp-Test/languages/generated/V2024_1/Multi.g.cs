...
#nullable enable
namespace Examples.V2024_1.Multi.M2;
using LionWeb.Core;
...
public partial class MultiLanguage : LanguageBase<IMultiFactory>
{
	...
	public MultiLanguage(string id) : base(id, LionWebVersions.v2024_1)
	{
		...
		_container_libraries = new(() => new ContainmentBase<MultiLanguage>("60eh9gc18v-vyPc8t3zNGWKgKPQ8Pmu85RmAoWlSV8U", Container, this) { Key = "libraries", Name = "libraries", Optional = false, Multiple = true, Type = Examples.V2024_1.Library.M2.LibraryLanguage.Instance.Library });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [Examples.V2024_1.Library.M2.LibraryLanguage.Instance];
...
{
	private readonly List<Examples.V2024_1.Library.M2.Library> _libraries = [];
	...
	public IReadOnlyList<Examples.V2024_1.Library.M2.Library> Libraries { get => AsNonEmptyReadOnly(_libraries, MultiLanguage.Instance.Container_libraries); init => AddLibraries(value); }

	/// <remarks>Required Multiple Containment</remarks>
    	/// <exception cref = "InvalidValueException">If both Libraries and nodes are empty</exception>
        public Container AddLibraries(IEnumerable<Examples.V2024_1.Library.M2.Library> nodes)
	{
	...
	/// <remarks>Required Multiple Containment</remarks>
        ...
        public Container InsertLibraries(int index, IEnumerable<Examples.V2024_1.Library.M2.Library> nodes)
	{
	...
	/// <remarks>Required Multiple Containment</remarks>
        ...
        public Container RemoveLibraries(IEnumerable<Examples.V2024_1.Library.M2.Library> nodes)
	{
		var safeNodes = nodes?.ToList();
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature))
		{
			var enumerable = MultiLanguage.Instance.Container_libraries.AsNodes<Examples.V2024_1.Library.M2.Library>(value).ToList();

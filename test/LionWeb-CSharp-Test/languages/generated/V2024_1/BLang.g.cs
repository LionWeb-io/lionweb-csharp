...
#nullable enable
namespace Examples.V2024_1.Circular.B;
using LionWeb.Core;
...
public partial class BLangLanguage : LanguageBase<IBLangFactory>
{
	...
	public BLangLanguage(string id) : base(id, LionWebVersions.v2024_1)
	{
		...
		_bConcept_AEnumProp = new(() => new PropertyBase<BLangLanguage>("id-BConcept-AEnumProp", BConcept, this) { Key = "key-AEnumProp", Name = "AEnumProp", Optional = false, Type = Examples.V2024_1.Circular.A.ALangLanguage.Instance.AEnum });
		_bConcept_ARef = new(() => new ReferenceBase<BLangLanguage>("id-BConcept-ARef", BConcept, this) { Key = "key-ARef", Name = "ARef", Optional = true, Multiple = false, Type = Examples.V2024_1.Circular.A.ALangLanguage.Instance.AConcept });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [Examples.V2024_1.Circular.A.ALangLanguage.Instance];
...
{
	private Examples.V2024_1.Circular.A.AEnum? _aEnumProp = null;
	...
	public Examples.V2024_1.Circular.A.AEnum AEnumProp { get => _aEnumProp ?? throw new UnsetFeatureException(BLangLanguage.Instance.BConcept_AEnumProp); set => SetAEnumProp(value); }

	/// <remarks>Required Property</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public BConcept SetAEnumProp(Examples.V2024_1.Circular.A.AEnum value)
	{
	...
	private Examples.V2024_1.Circular.A.AConcept? _aRef = null;
	...
	public Examples.V2024_1.Circular.A.AConcept? ARef { get => _aRef; set => SetARef(value); }

	/// <remarks>Optional Single Reference</remarks>
        public BConcept SetARef(Examples.V2024_1.Circular.A.AConcept? value)
	{
		_aRef = value;
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (BLangLanguage.Instance.BConcept_AEnumProp.EqualsIdentity(feature))
		{
			if (value is Examples.V2024_1.Circular.A.AEnum v)
			{
				AEnumProp = v;
				return true;
			}
		...
		if (BLangLanguage.Instance.BConcept_ARef.EqualsIdentity(feature))
		{
			if (value is null or Examples.V2024_1.Circular.A.AConcept)
			{
				ARef = (Examples.V2024_1.Circular.A.AConcept?)value;
				return true;
			}

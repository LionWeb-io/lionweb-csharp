...
#nullable enable
namespace Examples.V2024_1.DeprecatedLang;
using LionWeb.Core;
...
public partial class DeprConcept : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (DeprecatedLanguage.Instance.DeprConcept_deprChild.EqualsIdentity(feature))
		{
			var enumerable = DeprecatedLanguage.Instance.DeprConcept_deprChild.AsNodes<Examples.V2024_1.DeprecatedLang.DeprIface>(value);
		...
		if (DeprecatedLanguage.Instance.DeprConcept_deprRef.EqualsIdentity(feature))
		{
			if (value is Examples.V2024_1.DeprecatedLang.DeprAnnotation v)
			{
				DeprRef = v;
				return true;
			}

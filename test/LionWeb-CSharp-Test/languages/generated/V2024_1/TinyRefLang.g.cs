...
#nullable enable
namespace Examples.V2024_1.TinyRefLang;
using LionWeb.Core;
...
public partial class MyConcept : NodeBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (TinyRefLangLanguage.Instance.MyConcept_multivaluedRef.EqualsIdentity(feature))
		{
			var enumerable = TinyRefLangLanguage.Instance.MyConcept_multivaluedRef.AsNodes<Examples.V2024_1.TinyRefLang.MyConcept>(value).ToList();
		...
		if (TinyRefLangLanguage.Instance.MyConcept_singularRef.EqualsIdentity(feature))
		{
			if (value is Examples.V2024_1.TinyRefLang.MyConcept v)
			{
				SingularRef = v;
				return true;
			}

...
public class DeprecatedLanguage : LanguageBase<IDeprecatedFactory>
{
	...
	{
		_deprConcept = new(() => new ConceptBase<DeprecatedLanguage>("MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NDY", this) { Key = "MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NDY", Name = "DeprConcept", Abstract = false, Partition = false, ExtendsLazy = new(() => BuiltInsLanguage.Instance.Node), FeaturesLazy = new(() => [DeprConcept_deprProp, DeprConcept_deprChild, DeprConcept_deprRef]) });

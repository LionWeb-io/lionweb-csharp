...
public partial class DeprecatedLanguage : LanguageBase<IDeprecatedFactory>
{
	...
	public DeprecatedLanguage(string id) : base(id)
	{
		_deprAnnotation = new(() => new AnnotationBase<DeprecatedLanguage>("MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NjE", this) { Key = "MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NjE", Name = "DeprAnnotation", AnnotatesLazy = new(() => BuiltInsLanguage.Instance.Node) });
		_deprConcept = new(() => new ConceptBase<DeprecatedLanguage>("MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NDY", this) { Key = "MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NDY", Name = "DeprConcept", Abstract = false, Partition = false, ExtendsLazy = new(() => BuiltInsLanguage.Instance.Node), FeaturesLazy = new(() => [DeprConcept_deprChild, DeprConcept_deprProp, DeprConcept_deprRef]) });

...
public partial class SDTConcept : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (SDTLangLanguage.Instance.SDTConcept_decimal.EqualsIdentity(feature))
		{
			...
			{
				SetDecimal((LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.Decimal?)value);
				return true;
			}
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (SDTLangLanguage.Instance.SDTConcept_A.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.A)
			return SetARaw((LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.A?)value);
		if (SDTLangLanguage.Instance.SDTConcept_amount.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.Amount)
			return SetAmountRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.Amount?)value);
		if (SDTLangLanguage.Instance.SDTConcept_complex.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.ComplexNumber)
			return SetComplexRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.ComplexNumber?)value);
		if (SDTLangLanguage.Instance.SDTConcept_decimal.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.Decimal)
			return SetDecimalRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.SDTLang.Decimal?)value);
		return false;
	}

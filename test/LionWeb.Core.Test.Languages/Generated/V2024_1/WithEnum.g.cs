...
public partial class EnumHolder : ConceptInstanceBase
{
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (WithEnumLanguage.Instance.EnumHolder_enumValue.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.WithEnum.M2.MyEnum)
			return SetEnumValueRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.WithEnum.M2.MyEnum?)value);
		return false;
	}

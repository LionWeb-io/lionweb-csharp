...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedConceptLang;
using LionWeb.Core;
...
public partial class MixedConceptLangLanguage : LanguageBase<IMixedConceptLangFactory>
{
	...
	{
		_mixedConcept = new(() => new ConceptBase<MixedConceptLangLanguage>("id-mixedConcept", this) { Key = "key-mixedConcept", Name = "MixedConcept", Abstract = false, Partition = false, ExtendsLazy = new(() => LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseConceptLang.MixedBaseConceptLangLanguage.Instance.BaseConcept) });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseConceptLang.MixedBaseConceptLangLanguage.Instance];
...
public partial class MixedConcept : LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseConceptLang.BaseConcept
{

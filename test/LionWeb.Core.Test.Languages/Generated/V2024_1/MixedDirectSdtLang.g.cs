...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedDirectSdtLang;
using LionWeb.Core;
...
public partial class MixedDirectSdtLangLanguage : LanguageBase<IMixedDirectSdtLangFactory>
{
	...
	public MixedDirectSdtLangLanguage(string id) : base(id, LionWebVersions.v2024_1)
	{
		...
		_directSdt_directSdtEnum = new(() => new FieldBase<MixedDirectSdtLangLanguage>("id-directSdtEnum", DirectSdt, this) { Key = "key-directSdtEnum", Name = "directSdtEnum", Type = LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedEnumLang.MixedNestedEnumLangLanguage.Instance.NestedEnum });
		_directSdt_directSdtSdt = new(() => new FieldBase<MixedDirectSdtLangLanguage>("id-directSdtSdt", DirectSdt, this) { Key = "key-directSdtSdt", Name = "directSdtSdt", Type = LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedSdtLang.MixedNestedSdtLangLanguage.Instance.NestedSdt });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedEnumLang.MixedNestedEnumLangLanguage.Instance, LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedSdtLang.MixedNestedSdtLangLanguage.Instance];
...
public class MixedDirectSdtLangFactory : AbstractBaseNodeFactory, IMixedDirectSdtLangFactory
{
        ...
        public override IStructuredDataTypeInstance CreateStructuredDataTypeInstance(StructuredDataType structuredDataType, IFieldValues fieldValues)
	{
		if (_language.DirectSdt.EqualsIdentity(structuredDataType))
			return new DirectSdt((LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedEnumLang.NestedEnum?)fieldValues.Get(_language.DirectSdt_directSdtEnum), (LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedSdtLang.NestedSdt?)fieldValues.Get(_language.DirectSdt_directSdtSdt));
...
{
	private readonly LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedEnumLang.NestedEnum? _directSdtEnum;
	[LionCoreMetaPointer(Language = typeof(MixedDirectSdtLangLanguage), Key = "key-directSdtEnum")]
	public LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedEnumLang.NestedEnum DirectSdtEnum { get => _directSdtEnum ?? throw new UnsetFieldException(MixedDirectSdtLangLanguage.Instance.DirectSdt_directSdtEnum); init => _directSdtEnum = value; }

	private readonly LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedSdtLang.NestedSdt? _directSdtSdt;
	[LionCoreMetaPointer(Language = typeof(MixedDirectSdtLangLanguage), Key = "key-directSdtSdt")]
	public LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedSdtLang.NestedSdt DirectSdtSdt { get => _directSdtSdt ?? throw new UnsetFieldException(MixedDirectSdtLangLanguage.Instance.DirectSdt_directSdtSdt); init => _directSdtSdt = value; }
	...
	internal DirectSdt(LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedEnumLang.NestedEnum? directSdtEnum, LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedNestedSdtLang.NestedSdt? directSdtSdt)
	{

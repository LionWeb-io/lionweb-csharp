...
public partial class @out : @struct
{
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (ClassLanguage.Instance.out_default.EqualsIdentity(feature) && value is null or @namespace.@int.@public.V2024_1.@if)
			return SetDefaultRaw((@namespace.@int.@public.V2024_1.@if?)value);
		return false;
	}
...
/// <remarks>Required Property</remarks>
 @interface @interface.SetString(@enum value) => SetString(value);
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (ClassLanguage.Instance.interface_string.EqualsIdentity(feature) && value is null or @namespace.@int.@public.V2024_1.@enum)
			return SetStringRaw((@namespace.@int.@public.V2024_1.@enum?)value);
		return false;
	}
	...
	protected override bool SetContainmentRaw(Containment feature, IWritableNode? value)
	{
		if (base.SetContainmentRaw(feature, value))
			return true;
		if (ClassLanguage.Instance.record_double.EqualsIdentity(feature) && value is null or @namespace.@int.@public.V2024_1.@interface)
			return SetDoubleRaw((@namespace.@int.@public.V2024_1.@interface?)value);
		return false;
	}

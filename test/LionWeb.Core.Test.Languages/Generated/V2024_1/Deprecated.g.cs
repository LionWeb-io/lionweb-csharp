...
using global::Io.Lionweb.Mps.Specific.V2024_1;
...
public partial class DeprConcept : ConceptInstanceBase
{
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (DeprecatedLanguage.Instance.DeprConcept_deprChild.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2024_1.DeprecatedLang.DeprIface v0)

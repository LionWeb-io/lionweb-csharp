...
public partial class DeprecatedLanguage : LanguageBase<IDeprecatedFactory>
{
	...
	{
		_deprAnnotation = new(() => new AnnotationBase<DeprecatedLanguage>("MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NjE", this) { Key = "MDkzNjAxODQtODU5OC00NGU3LTliZjUtZmIxY2U0NWE0ODBhLzc4MTUyNDM0Nzk0ODc5OTM0NjE", Name = "DeprAnnotation", AnnotatesLazy = new(() => _builtIns.Node), Annotations = [new Deprecated("deprecatedAnnotation0") { Build = "deprAnnotation build", Comment = "deprAnnotation comment" }] });

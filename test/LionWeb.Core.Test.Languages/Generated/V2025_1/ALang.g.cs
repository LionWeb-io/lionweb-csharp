...
public partial class ALangLanguage : LanguageBase<IALangFactory>
{
	...
	public ALangLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
		...
		_aConcept_BProp = new(() => new PropertyBase<ALangLanguage>("id-BProp", AConcept, this) { Key = "key-BProp", Name = "BProp", Optional = false, Type = LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B.BLangLanguage.Instance.CustomPrimitiveType });
...
public partial class AConcept : ConceptInstanceBase
{
	...
	{
		bRef = ReferenceTargetNullableTarget<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B.BConcept>(_bRef, ALangLanguage.Instance.AConcept_BRef);
		return bRef != null;
	}

	private AConcept SetBRef(ReferenceTarget? value)
	{
		SetOptionalSingleReference<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B.BConcept>(value, ALangLanguage.Instance.AConcept_BRef, _bRef, SetBRefRaw);
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (ALangLanguage.Instance.AConcept_BRef.EqualsIdentity(feature))
		{
			...
			{
				SetBRef((LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B.BConcept?)value);
				return true;
			}

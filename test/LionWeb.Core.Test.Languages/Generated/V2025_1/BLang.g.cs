...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B;
...
/// bLang desc
/// <seealso cref = "LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.ALangLanguage"/>
...
public partial class BLangLanguage : LanguageBase<IBLangFactory>
{
	...
	public BLangLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
		...
		_bConcept_AEnumProp = new(() => new PropertyBase<BLangLanguage>("id-BConcept-AEnumProp", BConcept, this) { Key = "key-AEnumProp", Name = "AEnumProp", Optional = false, Type = LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.ALangLanguage.Instance.AEnum });
		_bConcept_AProp = new(() => new PropertyBase<BLangLanguage>("id-AProp", BConcept, this) { Key = "key-AProp", Name = "AProp", Optional = false, Type = LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.ALangLanguage.Instance.CustomPrimitiveType });
		_bConcept_ARef = new(() => new ReferenceBase<BLangLanguage>("id-BConcept-ARef", BConcept, this) { Key = "key-ARef", Name = "ARef", Optional = true, Multiple = false, Type = LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.ALangLanguage.Instance.AConcept });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.ALangLanguage.Instance];
...
{
	private LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum? _aEnumProp = null;
	private bool SetAEnumPropRaw(LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum? value)
	{
		if (value == _aEnumProp)
			return false;
		_aEnumProp = value;
	...
	public LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum AEnumProp { get => _aEnumProp ?? throw new UnsetFeatureException(BLangLanguage.Instance.BConcept_AEnumProp); set => SetAEnumProp(value); }

	/// enum desc
    	/// <seealso cref = "LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.ALangLanguage"/>
    	/// <seealso cref = "LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept.BRef"/>
    	/// <remarks>Required Property</remarks>
        public bool TryGetAEnumProp([NotNullWhenAttribute(true)] out LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum? aEnumProp)
	{
	...
	/// enum desc
    	...
    	/// <seealso cref = "LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept.BRef"/>
    	/// <remarks>Required Property</remarks>
        public BConcept SetAEnumProp(LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum value)
	{
		SetRequiredValueTypeProperty<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum>(value, BLangLanguage.Instance.BConcept_AEnumProp, _aEnumProp, SetAEnumPropRaw);
		return this;
	}
	...
	public LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept? ARef { get => ReferenceTargetNonNullTarget<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept>(_aRef, BLangLanguage.Instance.BConcept_ARef); set => SetARef(value); }

	/// <remarks>Optional Single Reference</remarks>
        public bool TryGetARef([NotNullWhenAttribute(true)] out LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept? aRef)
	{
		aRef = ReferenceTargetNullableTarget<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept>(_aRef, BLangLanguage.Instance.BConcept_ARef);
		return aRef != null;
	}

	private BConcept SetARef(ReferenceTarget? value)
	{
		SetOptionalSingleReference<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept>(value, BLangLanguage.Instance.BConcept_ARef, _aRef, SetARefRaw);
		return this;
	}
	...
	/// <remarks>Optional Single Reference</remarks>
        public BConcept SetARef(LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept? value)
	{
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (BLangLanguage.Instance.BConcept_AEnumProp.EqualsIdentity(feature))
		{
			if (value is LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum v)
			{
				SetAEnumProp(v);
				return true;
			}
		...
		if (BLangLanguage.Instance.BConcept_ARef.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept)
			{
				SetARef((LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept?)value);
				return true;
			}
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (BLangLanguage.Instance.BConcept_AEnumProp.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum)
			return SetAEnumPropRaw((LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum?)value);

...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2025_1.Mixed.MixedNestedEnumLang;
using LionWeb.Core;
...
public partial class MixedNestedEnumLangLanguage : LanguageBase<IMixedNestedEnumLangFactory>
{
	...
	public MixedNestedEnumLangLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{

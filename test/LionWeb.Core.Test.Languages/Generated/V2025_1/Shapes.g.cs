...
public partial class BillOfMaterials : AnnotationInstanceBase
{
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (ShapesLanguage.Instance.BillOfMaterials_altGroups.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2025_1.Shapes.M2.MaterialGroup v0)
			return AddAltGroupsRaw(v0);
		if (ShapesLanguage.Instance.BillOfMaterials_groups.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2025_1.Shapes.M2.MaterialGroup v1)
...
public partial class CompositeShape : Shape
{
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (ShapesLanguage.Instance.CompositeShape_disabledParts.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2025_1.Shapes.M2.IShape v0)
			return AddDisabledPartsRaw(v0);
		if (ShapesLanguage.Instance.CompositeShape_parts.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2025_1.Shapes.M2.IShape v1)
...
public partial class Geometry : ConceptInstanceBase, IPartitionInstance<INode>
{
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (ShapesLanguage.Instance.Geometry_shapes.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2025_1.Shapes.M2.IShape v0)
...
/// <exception cref="InvalidValueException">If set to null</exception>
 IShape IShape.SetUuid(string value) => SetUuid(value);
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (ShapesLanguage.Instance.IShape_fixpoints.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2025_1.Shapes.M2.Coord v0)

...
public partial class BLangLanguage : LanguageBase<IBLangFactory>
{
	...
	public BLangLanguage(string id) : base(id, LionWebVersions.v2023_1)
	{
		...
		_bConcept_AProp = new(() => new PropertyBase<BLangLanguage>("id-AProp", BConcept, this) { Key = "key-AProp", Name = "AProp", Optional = false, Type = LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.A.ALangLanguage.Instance.CustomPrimitiveType });

...
{
	private bool SetLibrariesRaw(List<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> nodes) => ExchangeChildrenRaw(nodes, WritableLibraries());
	private bool AddLibrariesRaw(LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library? value) => AddChildRaw(value, WritableLibraries());
	...
	private List<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> WritableLibraries() => _libraries is not null ? _libraries : _libraries = [];
	...
	{
		AddRequiredMultipleContainment<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(nodes, MultiLanguage.Instance.Container_libraries, WritableLibraries(), AddLibrariesRaw);
		return this;
	}
	...
	/// <remarks>Required Multiple Containment</remarks>
        ...
        public Container InsertLibraries(int index, IEnumerable<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> nodes)
	{
		InsertRequiredMultipleContainment<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(index, nodes, MultiLanguage.Instance.Container_libraries, WritableLibraries(), InsertLibrariesRaw);
		return this;
	}

	/// <remarks>Required Multiple Containment</remarks>
    	/// <exception cref = "InvalidValueException">If Libraries would be empty</exception>
        public Container RemoveLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> nodes)
	{
		RemoveRequiredMultipleContainment<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(nodes, MultiLanguage.Instance.Container_libraries, _libraries, RemoveLibrariesRaw);
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature))
		{
			SetRequiredMultipleContainment<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(value, MultiLanguage.Instance.Container_libraries, WritableLibraries(), SetLibrariesRaw);
			return true;
		}
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library v0)
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			InsertLibraries(index, MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			RemoveLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(value));
			return true;
		}
        ...
        protected override bool DetachChild(INode child, bool notify)
	{
		...
		{
			RemoveSelfParent((LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library)child, WritableLibraries(), MultiLanguage.Instance.Container_libraries, null, notify ? ContainmentRemover<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library>(MultiLanguage.Instance.Container_libraries) : null);
			return true;
		}
        ...
        public override Containment? GetContainmentOf(INode child)
	{
		...
		if (result != null)
			return result;
		if (child is LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library child0 && (_libraries?.Contains(child0) ?? false))

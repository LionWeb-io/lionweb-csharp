...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2026_1.myLowerCaseLang;
...
public partial class MyLowerCaseLangLanguage : LanguageBase<IMyLowerCaseLangFactory>
{
	...
	public MyLowerCaseLangLanguage(string id) : base(id, LionWebVersions.v2026_1)
	{
...
public partial class myConcept : ConceptInstanceBase
{
	...
	{
		SetRequiredReferenceTypeProperty<string>(value, MyLowerCaseLangLanguage.Instance.myConcept_myProperty, _myProperty, SetMyPropertyRaw);
		return this;
	}
	...
	public IReadableNode MyReference { get => ReferenceTargetNonNullTarget<IReadableNode>(_myReference, MyLowerCaseLangLanguage.Instance.myConcept_myReference) ?? throw new UnsetFeatureException(MyLowerCaseLangLanguage.Instance.myConcept_myReference); set => SetMyReference(value); }

	/// <remarks>Required Single Reference</remarks>
        public bool TryGetMyReference([NotNullWhenAttribute(true)] out IReadableNode? myReference)
	{
		myReference = ReferenceTargetNullableTarget<IReadableNode>(_myReference, MyLowerCaseLangLanguage.Instance.myConcept_myReference);
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (MyLowerCaseLangLanguage.Instance.myConcept_myProperty.EqualsIdentity(feature) && value is null or string)
	...
	protected override bool SetContainmentRaw(Containment feature, IWritableNode? value)
	{
		if (base.SetContainmentRaw(feature, value))
			return true;
		if (MyLowerCaseLangLanguage.Instance.myConcept_myContainment.EqualsIdentity(feature) && value is null or INode)
        ...
        protected override bool DetachChild(INode child, bool notify)
	{
		...
		if (MyLowerCaseLangLanguage.Instance.myConcept_myContainment.EqualsIdentity(c))
		{
			_myContainment = null;
			if (notify)
				NotifyRemoveFromParent<INode>(child, MyLowerCaseLangLanguage.Instance.myConcept_myContainment);
			return true;
		}

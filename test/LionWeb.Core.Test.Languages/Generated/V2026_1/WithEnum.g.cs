...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2026_1.WithEnum.M2;
...
public partial class WithEnumLanguage : LanguageBase<IWithEnumFactory>
{
	...
	public WithEnumLanguage(string id) : base(id, LionWebVersions.v2026_1)
	{
...
public partial class EnumHolder : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (WithEnumLanguage.Instance.EnumHolder_enumValue.EqualsIdentity(feature))
		{
			if (value is LionWeb.Core.Test.Languages.Generated.V2026_1.WithEnum.M2.MyEnum v)
			{
				SetEnumValue(v);
				return true;
			}
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (WithEnumLanguage.Instance.EnumHolder_enumValue.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.WithEnum.M2.MyEnum)
			return SetEnumValueRaw((LionWeb.Core.Test.Languages.Generated.V2026_1.WithEnum.M2.MyEnum?)value);
		return false;
	}

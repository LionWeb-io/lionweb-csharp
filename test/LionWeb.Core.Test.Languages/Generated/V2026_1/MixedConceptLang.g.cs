...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2026_1.Mixed.MixedConceptLang;
...
public partial class MixedConceptLangLanguage : LanguageBase<IMixedConceptLangFactory>
{
	...
	public MixedConceptLangLanguage(string id) : base(id, LionWebVersions.v2026_1)
	{
		_mixedConcept = new(() => new ConceptBase<MixedConceptLangLanguage>("id-mixedConcept", this) { Key = "key-mixedConcept", Name = "MixedConcept", Abstract = false, Partition = false, ExtendsLazy = new(() => LionWeb.Core.Test.Languages.Generated.V2026_1.Mixed.MixedBaseConceptLang.MixedBaseConceptLangLanguage.Instance.BaseConcept) });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [LionWeb.Core.Test.Languages.Generated.V2026_1.Mixed.MixedBaseConceptLang.MixedBaseConceptLangLanguage.Instance];
...
public partial class MixedConcept : LionWeb.Core.Test.Languages.Generated.V2026_1.Mixed.MixedBaseConceptLang.BaseConcept
{

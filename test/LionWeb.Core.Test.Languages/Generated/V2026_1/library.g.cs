...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2;
...
public partial class LibraryLanguage : LanguageBase<ILibraryFactory>
{
	...
	public LibraryLanguage(string id) : base(id, LionWebVersions.v2026_1)
	{
...
public partial class Book : ConceptInstanceBase
{
	...
	{
		SetRequiredValueTypeProperty<int>(value, LibraryLanguage.Instance.Book_pages, _pages, SetPagesRaw);
		return this;
	}
	...
	{
		SetRequiredReferenceTypeProperty<string>(value, LibraryLanguage.Instance.Book_title, _title, SetTitleRaw);
		return this;
	}
	...
	{
		SetOptionalValueTypeProperty<BookType>(value, LibraryLanguage.Instance.Book_type, _type, SetTypeRaw);
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (LibraryLanguage.Instance.Book_author.EqualsIdentity(feature))
		{
			if (value is LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Writer v)
			{
				SetAuthor(v);
				return true;
			}
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.BookType)
			{
				SetType((LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.BookType?)value);
				return true;
			}
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.BookType)
			return SetTypeRaw((LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.BookType?)value);
		return false;
	}
...
public partial class GuideBookWriter : Writer
{
	...
	{
		SetRequiredReferenceTypeProperty<string>(value, LibraryLanguage.Instance.GuideBookWriter_countries, _countries, SetCountriesRaw);
		return this;
	}
...
public partial class Library : ConceptInstanceBase
{
	...
	{
		SetRequiredReferenceTypeProperty<string>(value, LibraryLanguage.Instance.Library_name, _name, SetNameRaw);
		return this;
	}
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Book v0)
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddBooks(LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Book>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(link))
		{
			InsertBooks(index, LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Book>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(link))
		{
			RemoveBooks(LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Book>(value));
			return true;
		}
...
public partial class SpecialistBookWriter : Writer
{
	...
	{
		SetRequiredReferenceTypeProperty<string>(value, LibraryLanguage.Instance.SpecialistBookWriter_subject, _subject, SetSubjectRaw);
		return this;
	}
...
public partial class Writer : ConceptInstanceBase
{
	...
	{
		SetRequiredReferenceTypeProperty<string>(value, LibraryLanguage.Instance.Writer_name, _name, SetNameRaw);
		return this;
	}

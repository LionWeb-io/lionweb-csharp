...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2026_1.Multi.M2;
...
public partial class MultiLanguage : LanguageBase<IMultiFactory>
{
	...
	public MultiLanguage(string id) : base(id, LionWebVersions.v2026_1)
	{
		...
		_container_libraries = new(() => new ContainmentBase<MultiLanguage>("60eh9gc18v-vyPc8t3zNGWKgKPQ8Pmu85RmAoWlSV8U", Container, this) { Key = "libraries", Name = "libraries", Optional = false, Multiple = true, Type = LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.LibraryLanguage.Instance.Library });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.LibraryLanguage.Instance];
...
public partial class Container : ConceptInstanceBase
{
	...
	private IReadOnlyList<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library> ReadOnlyLibraries() => _libraries is not null ? _libraries.AsReadOnly() : [];
	private List<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library> WritableLibraries() => _libraries is not null ? _libraries : _libraries = [];
	...
	public IReadOnlyList<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library> Libraries { get => AsNonEmptyReadOnly(_libraries, MultiLanguage.Instance.Container_libraries); init => AddLibraries(value); }
	...
	/// <remarks>Required Multiple Containment</remarks>
        ...
        public Container RemoveLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library> nodes)
	{
		RemoveRequiredMultipleContainment<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library>(nodes, MultiLanguage.Instance.Container_libraries, _libraries, RemoveLibrariesRaw);
		return this;
	}
	...
	protected override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library v0)
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			InsertLibraries(index, MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			RemoveLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2026_1.Library.M2.Library>(value));
			return true;
		}

...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.A;
...
public partial class ALangLanguage : LanguageBase<IALangFactory>
{
	...
	public ALangLanguage(string id) : base(id, LionWebVersions.v2026_1)
	{
		...
		_aConcept_BProp = new(() => new PropertyBase<ALangLanguage>("id-BProp", AConcept, this) { Key = "key-BProp", Name = "BProp", Optional = false, Type = LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BLangLanguage.Instance.CustomPrimitiveType });
		_aConcept_BRef = new(() => new ReferenceBase<ALangLanguage>("id-AConcept-BRef", AConcept, this) { Key = "key-BRef", Name = "BRef", Optional = true, Multiple = false, Type = LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BLangLanguage.Instance.BConcept });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BLangLanguage.Instance];
...
public partial class AConcept : ConceptInstanceBase
{
	...
	public LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept? BRef { get => ReferenceTargetNonNullTarget<LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept>(_bRef, ALangLanguage.Instance.AConcept_BRef); set => SetBRef(value); }

	/// <summary>bRef desc</summary>
    	/// <seealso cref = "AEnum.left"/>
    	/// <seealso cref = "AConcept.BRef"/>
    	/// <remarks>Optional Single Reference</remarks>
        public bool TryGetBRef([NotNullWhenAttribute(true)] out LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept? bRef)
	{
		bRef = ReferenceTargetNullableTarget<LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept>(_bRef, ALangLanguage.Instance.AConcept_BRef);
		return bRef != null;
	}

	private AConcept SetBRef(ReferenceTarget? value)
	{
		SetOptionalSingleReference<LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept>(value, ALangLanguage.Instance.AConcept_BRef, _bRef, SetBRefRaw);
		return this;
	}
	...
	/// <summary>bRef desc</summary>
    	...
    	/// <seealso cref = "AConcept.BRef"/>
    	/// <remarks>Optional Single Reference</remarks>
        public AConcept SetBRef(LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept? value)
	{
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (ALangLanguage.Instance.AConcept_BRef.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept)
			{
				SetBRef((LionWeb.Core.Test.Languages.Generated.V2026_1.Circular.B.BConcept?)value);
				return true;
			}

...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang;
...
public partial class SDTLangLanguage : LanguageBase<ISDTLangFactory>
{
	...
	public SDTLangLanguage(string id) : base(id, LionWebVersions.v2026_1)
	{
...
public partial class SDTConcept : ConceptInstanceBase
{
	...
	{
		SetRequiredValueTypeProperty<A>(value, SDTLangLanguage.Instance.SDTConcept_A, _a, SetARaw);
		return this;
	}
	...
	{
		SetRequiredValueTypeProperty<Amount>(value, SDTLangLanguage.Instance.SDTConcept_amount, _amount, SetAmountRaw);
		return this;
	}
	...
	{
		SetRequiredValueTypeProperty<ComplexNumber>(value, SDTLangLanguage.Instance.SDTConcept_complex, _complex, SetComplexRaw);
		return this;
	}
	...
	{
		SetOptionalValueTypeProperty<Decimal>(value, SDTLangLanguage.Instance.SDTConcept_decimal, _decimal, SetDecimalRaw);
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, object? value)
	{
		...
		if (SDTLangLanguage.Instance.SDTConcept_A.EqualsIdentity(feature))
		{
			if (value is LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.A v)
			{
				SetA(v);
				return true;
			}
		...
		if (SDTLangLanguage.Instance.SDTConcept_amount.EqualsIdentity(feature))
		{
			if (value is LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.Amount v)
			{
				SetAmount(v);
				return true;
			}
		...
		if (SDTLangLanguage.Instance.SDTConcept_complex.EqualsIdentity(feature))
		{
			if (value is LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.ComplexNumber v)
			{
				SetComplex(v);
				return true;
			}
		...
		if (SDTLangLanguage.Instance.SDTConcept_decimal.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.Decimal)
			{
				SetDecimal((LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.Decimal?)value);
				return true;
			}
	...
	protected override bool SetPropertyRaw(Property feature, object? value)
	{
		if (base.SetPropertyRaw(feature, value))
			return true;
		if (SDTLangLanguage.Instance.SDTConcept_A.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.A)
			return SetARaw((LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.A?)value);
		if (SDTLangLanguage.Instance.SDTConcept_amount.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.Amount)
			return SetAmountRaw((LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.Amount?)value);
		if (SDTLangLanguage.Instance.SDTConcept_complex.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.ComplexNumber)
			return SetComplexRaw((LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.ComplexNumber?)value);
		if (SDTLangLanguage.Instance.SDTConcept_decimal.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.Decimal)
			return SetDecimalRaw((LionWeb.Core.Test.Languages.Generated.V2026_1.SDTLang.Decimal?)value);
		return false;
	}

...
#nullable enable
namespace LionWeb.Core.Test.Languages;
using LionWeb.Core;
...
/// <summary>
/// Language as generated before raw API refactoring.
/// Kept here to assure framework compatibility with older languages.
/// </summary>
...
public partial class TestLanguageLanguage : LanguageBase<ITestLanguageFactory>
{
	...
	public TestLanguageLanguage(string id) : base(id, LionWebVersions.v2024_1)
	{
...
public partial class DataTypeTestConcept : ConceptInstanceBase, IPartitionInstance<INode>
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (TestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_0_1.EqualsIdentity(feature))
		{
			if (value is null or TestEnumeration)
			{
				SetEnumValue_0_1((TestEnumeration?)value, notificationId);
				return true;
			}
...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(feature))
		{
			if (value is null or LinkTestConcept)
			{
				SetContainment_0_1((LinkTestConcept?)value, notificationId);
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LinkTestConcept>(value).ToList();
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LinkTestConcept>(value).ToList();
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_1.EqualsIdentity(feature))
		{
			if (value is null or LinkTestConcept)
			{
				SetReference_0_1((LinkTestConcept?)value, notificationId);
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsReferenceTargets<LinkTestConcept>(value).ToList();
			AssureNotNull(safeNodes, TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
			AssureNotNullMembers(safeNodes, TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsReferenceTargets<LinkTestConcept>(value).ToList();
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddContainment_0_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(link))
		{
			AddContainment_1_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(link))
		{
			AddReference_0_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(link))
		{
			AddReference_1_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsNodes<LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(link))
		{
			InsertContainment_0_n(index, TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(link))
		{
			InsertContainment_1_n(index, TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(link))
		{
			InsertReference_0_n(index, TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(link))
		{
			InsertReference_1_n(index, TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsNodes<LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(link))
		{
			RemoveContainment_0_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(link))
		{
			RemoveContainment_1_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(link))
		{
			RemoveReference_0_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(link))
		{
			RemoveReference_1_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsNodes<LinkTestConcept>(value));
			return true;
		}

...
public class DeserializerBenchmark : SerializerBenchmarkBase
{
    [Benchmark]
    [TestMethod]
    public async Task Deserialize_Stream()
    {
    ...
    [Benchmark]
    [TestMethod]
    public async Task Deserialize_Stream_Context()
    {
        await using Stream stream = File.OpenRead(_streamFile);
    ...
    [Benchmark]
    [TestMethod]
    public void Deserialize_String_Context()
    {
    ...
    private static async Task<List<IReadableNode>> ReadNodesFromStreamAsync(Stream utf8JsonStream, IDeserializer deserializer,
        JsonSerializerOptions jsonSerializerOptions, Action<string>? lionWebVersionChecker = null)
    {

...
public partial class AConcept : ConceptInstanceBase
{
	...
	{
		LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.B.BConcept? oldValue = _bRef;
		_bRef = value;
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ALangLanguage.Instance.AConcept_BRef.EqualsIdentity(feature))
		{
			...
			{
				BRef = (LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.B.BConcept?)value;
				return true;
			}

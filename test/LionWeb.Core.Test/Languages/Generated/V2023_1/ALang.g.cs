...
public partial class AConcept : ConceptInstanceBase
{
	...
	private AConcept SetBRef(ReferenceTarget? value)
	{
		...
		ReferenceSingleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.B.BConcept> emitter = new(ALangLanguage.Instance.AConcept_BRef, this, value, _bRef);

...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(value).ToList();
		...
		if (TestLanguageLanguage.Instance.TestPartition_dataType.EqualsIdentity(feature))
		{
			...
			{
				SetDataType((LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.DataTypeTestConcept?)value, notificationId);
				return true;
			}
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddContents(TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			InsertContents(index, TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			RemoveContents(TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(value));
			return true;
		}

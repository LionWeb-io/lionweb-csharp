...
public partial class DataTypeTestConcept : ConceptInstanceBase, IPartitionInstance<INode>
{
    ...
    public override bool SetInternal(Feature? feature, object? value, IEventId? eventId)
	{
		...
		if (TestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_0_1.EqualsIdentity(feature))
		{
			...
			{
				EnumValue_0_1 = (LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.TestEnumeration?)value;
				return true;
			}
 ...
 INamedWritable INamedWritable.SetName(string value) => SetName(value);
    ...
    public override bool SetInternal(Feature? feature, object? value, IEventId? eventId)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(feature))
		{
			...
			{
				Containment_0_1 = (LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept?)value;
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_1.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept)
			{
				Reference_0_1 = (LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept?)value;
				return true;
			}

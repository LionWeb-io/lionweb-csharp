...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		{
			AddContainment_0_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(link))
		{
			AddContainment_1_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(link))
		{
			AddReference_0_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(link))
		{
			AddReference_1_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> nodes)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(link))
		{
			InsertContainment_0_n(index, TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(link))
		{
			InsertContainment_1_n(index, TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(link))
		{
			InsertReference_0_n(index, TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(link))
		{
			InsertReference_1_n(index, TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(link))
		{
			RemoveContainment_0_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(link))
		{
			RemoveContainment_1_n(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(link))
		{
			RemoveReference_0_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(link))
		{
			RemoveReference_1_n(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.TestLanguage.LinkTestConcept>(nodes));
			return true;
		}

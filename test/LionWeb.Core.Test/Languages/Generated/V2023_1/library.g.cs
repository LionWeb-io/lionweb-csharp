...
public partial class Book : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature))
		{
			...
			{
				Type = (LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.BookType?)value;
				return true;
			}
...
public partial class Library : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(feature))
		{
			var enumerable = LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Book>(value).ToList();

...
public partial class Container : ConceptInstanceBase
{
        ...
        public Container AddLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> nodes)
	{
		...
		AddMultipleContainmentsEvent<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> evt = new(MultiLanguage.Instance.Container_libraries, this, 0, safeNodes, _libraries);
		evt.CollectOldData();
        ...
        public Container InsertLibraries(int index, IEnumerable<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> nodes)
	{
		...
		AddMultipleContainmentsEvent<LionWeb.Core.Test.Languages.Generated.V2023_1.Library.M2.Library> evt = new(MultiLanguage.Instance.Container_libraries, this, index, safeNodes, _libraries);
		evt.CollectOldData();

...
public partial class BConcept : ConceptInstanceBase
{
	...
	/// enum desc
    	...
    	/// <remarks>Required Property</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public BConcept SetAEnumProp(LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.A.AEnum value, INotificationId? eventId = null)
	{
	...
	private LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.A.AConcept? _aRef = null;
	...
	/// <remarks>Optional Single Reference</remarks>
        public BConcept SetARef(LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.A.AConcept? value, INotificationId? eventId = null)
	{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? eventId = null)
	{
		...
		if (BLangLanguage.Instance.BConcept_ARef.EqualsIdentity(feature))
		{
			...
			{
				SetARef((LionWeb.Core.Test.Languages.Generated.V2023_1.Circular.A.AConcept?)value, eventId);
				return true;
			}

...
public partial class DataTypeTestConcept : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetEnumValue_0_1((LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.TestEnumeration?)value, notificationId);
				return true;
			}
 ...
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetContainment_0_1((LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept?)value, notificationId);
				return true;
			}
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_1.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept)
			{
				SetReference_0_1((LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept?)value, notificationId);
				return true;
			}
...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(feature))
		{
			var safeNodes = NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept>(value).ToList();
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_dataType.EqualsIdentity(feature))
		{
			...
			{
				SetDataType((LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.DataTypeTestConcept?)value, notificationId);
				return true;
			}
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddContents(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			InsertContents(index, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			RemoveContents(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept>(value));
			return true;
		}

 ...
 INamedWritable INamedWritable.SetName(string value) => SetName(value);
	...
	protected internal override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept v0)
			return AddContainment_0_nRaw(v0);
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept v1)
...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value) => SetName(value);
	...
	protected internal override bool AddContainmentsRaw(Containment feature, IWritableNode value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_links.EqualsIdentity(feature) && value is LionWeb.Core.Test.Languages.Generated.V2023_1.NullableReferencesTestLang.LinkTestConcept v0)

...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2025_1.MYUpperCaseLang;
using LionWeb.Core;
...
public partial class MYUpperCaseLangLanguage : LanguageBase<IMYUpperCaseLangFactory>
{
	...
	public MYUpperCaseLangLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
...
public partial class MYConcept : ConceptInstanceBase
{
	...
	private IReadableNode? MYReferenceTarget() => ReferenceTargetNonNullTarget<IReadableNode>(_mYReference, MYUpperCaseLangLanguage.Instance.MYConcept_MYReference);
	/// <remarks>Required Single Reference</remarks>

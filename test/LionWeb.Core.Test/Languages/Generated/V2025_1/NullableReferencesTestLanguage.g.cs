...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
	...
	public LinkTestConcept Reference_1 { get => Reference_1Target() ?? throw new UnsetFeatureException(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1); set => SetReference_1(value); }
	...
	public IReadOnlyList<LinkTestConcept> Reference_1_n { get => AsNonEmptyReadOnly<LinkTestConcept>(Reference_1_nTargets(), NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n); init => AddReference_1_n(value); }
        ...
        public LinkTestConcept RemoveReference_1_n(IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		AssureNotNull(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n);
		AssureNonEmpty(safeNodes, _reference_1_n, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n);
		AssureNotClearing(safeNodes, Reference_1_nTargets(), NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n);

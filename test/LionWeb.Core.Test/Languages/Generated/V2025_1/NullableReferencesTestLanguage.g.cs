...
public partial class NullableReferencesTestLanguageLanguage : LanguageBase<INullableReferencesTestLanguageFactory>
{
	...
	public NullableReferencesTestLanguageLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
		...
		_testAnnotation = new(() => new AnnotationBase<NullableReferencesTestLanguageLanguage>("TestAnnotation", this) { Key = "TestAnnotation", Name = "TestAnnotation", AnnotatesLazy = new(() => _builtIns.Node) });
		...
		_testPartition = new(() => new ConceptBase<NullableReferencesTestLanguageLanguage>("TestPartition", this) { Key = "TestPartition", Name = "TestPartition", Abstract = false, Partition = true, ImplementsLazy = new(() => [_builtIns.INamed]), FeaturesLazy = new(() => [TestPartition_contents, TestPartition_dataType]) });
		_testPartition_contents = new(() => new ContainmentBase<NullableReferencesTestLanguageLanguage>("TestPartition-contents", TestPartition, this) { Key = "TestPartition-contents", Name = "contents", Optional = true, Multiple = true, Type = LinkTestConcept });
		_testPartition_dataType = new(() => new ContainmentBase<NullableReferencesTestLanguageLanguage>("TestPartition-dataType", TestPartition, this) { Key = "TestPartition-dataType", Name = "dataType", Optional = true, Multiple = false, Type = DataTypeTestConcept });
...
public partial class DataTypeTestConcept : ConceptInstanceBase
{
	...
	{
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_booleanValue_0_1, this, value, _booleanValue_0_1, notificationId);
	...
	{
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_booleanValue_1, this, value, _booleanValue_1, notificationId);
		emitter.CollectOldData();
	...
	{
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_0_1, this, value, _enumValue_0_1, notificationId);
		emitter.CollectOldData();
        ...
        public DataTypeTestConcept SetEnumValue_1(TestEnumeration value, INotificationId? notificationId = null)
	{
		...
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_1, this, value, _enumValue_1, notificationId);
		emitter.CollectOldData();
		_enumValue_1 = value;
		emitter.Notify();
		return this;
	...
	{
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_integerValue_0_1, this, value, _integerValue_0_1, notificationId);
		emitter.CollectOldData();
	...
	{
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_integerValue_1, this, value, _integerValue_1, notificationId);
		emitter.CollectOldData();
	...
	{
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_stringValue_0_1, this, value, _stringValue_0_1, notificationId);
		emitter.CollectOldData();
        ...
        public DataTypeTestConcept SetStringValue_1(string value, INotificationId? notificationId = null)
	{
		...
		PropertyNotificationEmitter emitter = new(NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_stringValue_1, this, value, _stringValue_1, notificationId);
		emitter.CollectOldData();
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetEnumValue_0_1((LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.TestEnumeration?)value, notificationId);
				return true;
			}
...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
	...
	{
		ContainmentSingleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_1, this, value, _containment_0_1, notificationId);
		emitter.CollectOldData();
        ...
        public LinkTestConcept InsertContainment_0_n(int index, IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		AssureNotNullMembers(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_n);
		ContainmentAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_n, this, safeNodes, _containment_0_n, index, notificationId);
		emitter.CollectOldData();
		_containment_0_n.InsertRange(index, SetSelfParent(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_n));
		emitter.Notify();
		return this;
	}
        ...
        public LinkTestConcept SetContainment_1(LinkTestConcept value, INotificationId? notificationId = null)
	{
		...
		ContainmentSingleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_1, this, value, _containment_1, notificationId);
		emitter.CollectOldData();
        ...
        public LinkTestConcept InsertContainment_1_n(int index, IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		ContainmentAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, this, safeNodes, _containment_1_n, index, notificationId);
		emitter.CollectOldData();
		_containment_1_n.InsertRange(index, SetSelfParent(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_1_n));
		emitter.Notify();
		return this;
	}
	...
	private LinkTestConcept SetReference_0_1(ReferenceTarget? value, INotificationId? notificationId = null)
	{
		...
		ReferenceSingleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_1, this, value, _reference_0_1, notificationId);
		emitter.CollectOldData();
        ...
        public LinkTestConcept AddReference_0_n(IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		ReferenceAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, this, safeNodes, _reference_0_n.Count, notificationId);
		emitter.CollectOldData();
        ...
        public LinkTestConcept InsertReference_0_n(int index, IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		AssureNotNull(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
		AssureNotNullMembers(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
		ReferenceAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, this, safeNodes, index, notificationId);
		emitter.CollectOldData();
	...
	private LinkTestConcept SetReference_1(ReferenceTarget? value, INotificationId? notificationId = null)
	{
		...
		ReferenceSingleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1, this, value, _reference_1, notificationId);
		emitter.CollectOldData();
		_reference_1 = value;
		emitter.Notify();
		return this;
        ...
        public LinkTestConcept AddReference_1_n(IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		ReferenceAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, this, safeNodes, _reference_1_n.Count, notificationId);
		emitter.CollectOldData();
        ...
        public LinkTestConcept InsertReference_1_n(int index, IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		AssureNotNull(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n);
		AssureNonEmpty(safeNodes, _reference_1_n, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n);
		ReferenceAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, this, safeNodes, index, notificationId);
		emitter.CollectOldData();
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetContainment_0_1((LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.LinkTestConcept?)value, notificationId);
				return true;
			}
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(feature))
		{
			...
			ContainmentSetNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_n, this, safeNodes, _containment_0_n, notificationId);
			emitter.CollectOldData();
			RemoveSelfParent(_containment_0_n.ToList(), _containment_0_n, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_0_n);
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(feature))
		{
			...
			ContainmentSetNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, this, safeNodes, _containment_1_n, notificationId);
			emitter.CollectOldData();
			RemoveSelfParent(_containment_1_n.ToList(), _containment_1_n, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_containment_1_n);
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_1.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.LinkTestConcept)
			{
				SetReference_0_1((LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.LinkTestConcept?)value, notificationId);
				return true;
			}
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(feature))
		{
			...
			AssureNotNull(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
			AssureNotNullMembers(safeNodes, NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
			ReferenceSetNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, this, safeNodes, _reference_0_n, notificationId);
			emitter.CollectOldData();
		...
		if (NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(feature))
		{
			...
			ReferenceSetNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, this, safeNodes, _reference_1_n, notificationId);
			emitter.CollectOldData();
...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
	...
	/// <remarks>Optional Multiple Containment</remarks>
        [LionCoreMetaPointer(Language = typeof(NullableReferencesTestLanguageLanguage), Key = "TestPartition-contents")]
	[LionCoreFeature(Kind = LionCoreFeatureKind.Containment, Optional = true, Multiple = true)]
	...
	{
		var safeNodes = nodes?.ToList();
		AssureNotNull(safeNodes, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents);
		AssureNotNullMembers(safeNodes, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents);
		if (_contents.SequenceEqual(safeNodes))
			return this;
		foreach (var safeNode in safeNodes)
		{
			ContainmentAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents, this, [safeNode], _contents, null, notificationId);
			emitter.CollectOldData();
			_contents.AddRange(SetSelfParent([safeNode], NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents));
			emitter.Notify();
		}
        ...
        public TestPartition InsertContents(int index, IEnumerable<LinkTestConcept> nodes, INotificationId? notificationId = null)
	{
		...
		AssureNotNullMembers(safeNodes, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents);
		ContainmentAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents, this, safeNodes, _contents, index, notificationId);
		emitter.CollectOldData();
		_contents.InsertRange(index, SetSelfParent(safeNodes, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents));
		emitter.Notify();
		return this;
	}
	...
	{
		RemoveSelfParent(nodes?.ToList(), _contents, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents, ContainmentRemover<LinkTestConcept>(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents));
		return this;
	}

	private DataTypeTestConcept? _dataType = null;
	/// <remarks>Optional Single Containment</remarks>
        [LionCoreMetaPointer(Language = typeof(NullableReferencesTestLanguageLanguage), Key = "TestPartition-dataType")]
	[LionCoreFeature(Kind = LionCoreFeatureKind.Containment, Optional = true, Multiple = false)]
	...
	{
		ContainmentSingleNotificationEmitter<DataTypeTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.TestPartition_dataType, this, value, _dataType, notificationId);
		emitter.CollectOldData();
        ...
        protected override bool GetInternal(Feature? feature, out object? result)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(feature))
		{
			result = Contents;
			return true;
		}

		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_dataType.EqualsIdentity(feature))
		{
			result = DataType;
			return true;
		}
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(feature))
		{
			var safeNodes = NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.LinkTestConcept>(value).ToList();
			ContainmentSetNotificationEmitter<LinkTestConcept> emitter = new(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents, this, safeNodes, _contents, notificationId);
			emitter.CollectOldData();
			RemoveSelfParent(_contents.ToList(), _contents, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents);
			_contents.AddRange(SetSelfParent(safeNodes, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents));
			emitter.Notify();
			return true;
		}
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_dataType.EqualsIdentity(feature))
		{
			...
			{
				SetDataType((LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.DataTypeTestConcept?)value, notificationId);
				return true;
			}
        ...
        public override IEnumerable<Feature> CollectAllSetFeatures()
	{
		...
		if (TryGetContents(out _))
			result.Add(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents);
		if (TryGetDataType(out _))
			result.Add(NullableReferencesTestLanguageLanguage.Instance.TestPartition_dataType);
		return result;
	}
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		if (base.AddInternal(link, value))
			return true;
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			AddContents(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			InsertContents(index, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			RemoveContents(NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.NullableReferencesTestLang.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool DetachChild(INode child)
	{
		if (base.DetachChild(child))
			return true;
		Containment? c = GetContainmentOf(child);
		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(c))
		{
			RemoveSelfParent(child, _contents, NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents);
			return true;
		}

		if (NullableReferencesTestLanguageLanguage.Instance.TestPartition_dataType.EqualsIdentity(c))
		{
			_dataType = null;
			return true;
		}
        ...
        public override Containment? GetContainmentOf(INode child)
	{
		...
		if (child is LinkTestConcept child0 && _contents.Contains(child0))
			return NullableReferencesTestLanguageLanguage.Instance.TestPartition_contents;
		if (ReferenceEquals(_dataType, child))
			return NullableReferencesTestLanguageLanguage.Instance.TestPartition_dataType;
		return null;
	}
}

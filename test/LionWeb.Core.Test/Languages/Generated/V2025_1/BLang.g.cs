...
public partial class BConcept : ConceptInstanceBase
{
	...
	private ReferenceDescriptor<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept>? _aRef = null;
	...
	public LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept? ARef { get => ARefTarget(); set => SetARef(value); }

	private LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept? ARefTarget() => _aRef?.Target;
	/// <remarks>Optional Single Reference</remarks>
	...
	{
		ReferenceSingleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept> emitter = new(BLangLanguage.Instance.BConcept_ARef, this, ReferenceDescriptor.FromNodeOptional(value), _aRef, notificationId);
		emitter.CollectOldData();
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (BLangLanguage.Instance.BConcept_ARef.EqualsIdentity(feature))
		{
			...
			{
				SetARef((LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept?)value, notificationId);
				return true;
			}

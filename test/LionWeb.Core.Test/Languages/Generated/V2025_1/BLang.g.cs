...
public partial class BConcept : ConceptInstanceBase
{
        ...
        public BConcept SetAEnumProp(LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AEnum value)
	{
		...
		PropertyNotificationEmitter emitter = new(BLangLanguage.Instance.BConcept_AEnumProp, this, value, _aEnumProp);
		emitter.CollectOldData();
		if (SetAEnumPropRaw(value))
			emitter.Notify();
		return this;
	}
	...
	private BConcept SetARef(ReferenceTarget? value)
	{
		...
		ReferenceSingleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.A.AConcept> emitter = new(BLangLanguage.Instance.BConcept_ARef, this, value, _aRef);
		emitter.CollectOldData();
		if (SetARefRaw(value))
			emitter.Notify();
		return this;

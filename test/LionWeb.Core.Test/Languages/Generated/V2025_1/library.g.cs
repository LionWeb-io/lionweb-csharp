...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2;
using LionWeb.Core;
...
public partial class LibraryLanguage : LanguageBase<ILibraryFactory>
{
	...
	public LibraryLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
...
public partial class Book : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature))
		{
			...
			{
				SetType((LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.BookType?)value);
				return true;
			}
	...
	protected internal override bool SetPropertyRaw(Property feature, object? value)
	{
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.BookType)
			return SetTypeRaw((LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.BookType?)value);
		return false;
	}
...
public partial class Library : ConceptInstanceBase
{
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddBooks(LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Book>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(link))
		{
			InsertBooks(index, LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Book>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(link))
		{
			RemoveBooks(LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Book>(value));
			return true;
		}

...
public partial class Library : ConceptInstanceBase
{
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		{
			AddBooks(LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Book>(nodes));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> nodes)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(link))
		{
			InsertBooks(index, LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Book>(nodes));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(link))
		{
			RemoveBooks(LibraryLanguage.Instance.Library_books.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Book>(nodes));
			return true;
		}

...
public partial class AConcept : ConceptInstanceBase
{
	...
	/// bRef desc
    	...
    	/// <seealso cref = "AConcept.BRef"/>
    	/// <remarks>Optional Single Reference</remarks>
        public AConcept SetBRef(LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B.BConcept? value, IEventId? eventId = null)
	{
		ReferenceSingleEventEmitter evt = new(ALangLanguage.Instance.AConcept_BRef, this, value, _bRef, eventId);
		evt.CollectOldData();
		_bRef = value;
		evt.RaiseEvent();
		return this;

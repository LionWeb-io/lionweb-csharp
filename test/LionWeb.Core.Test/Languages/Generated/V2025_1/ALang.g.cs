...
public partial class AConcept : ConceptInstanceBase
{
	...
	{
		AssureNullableInstance<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B.BConcept>(value, ALangLanguage.Instance.AConcept_BRef);
		ReferenceSingleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2025_1.Circular.B.BConcept> emitter = new(ALangLanguage.Instance.AConcept_BRef, this, value, _bRef);

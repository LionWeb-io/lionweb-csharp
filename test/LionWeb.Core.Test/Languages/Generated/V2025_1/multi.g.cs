...
public partial class Container : ConceptInstanceBase
{
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		{
			AddLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library>(nodes));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> nodes)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			InsertLibraries(index, MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library>(nodes));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			RemoveLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library>(nodes));
			return true;
		}

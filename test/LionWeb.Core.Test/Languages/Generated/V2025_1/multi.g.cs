...
public partial class MultiLanguage : LanguageBase<IMultiFactory>
{
	...
	public MultiLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
		...
		_container_libraries = new(() => new ContainmentBase<MultiLanguage>("60eh9gc18v-vyPc8t3zNGWKgKPQ8Pmu85RmAoWlSV8U", Container, this) { Key = "libraries", Name = "libraries", Optional = false, Multiple = true, Type = LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.LibraryLanguage.Instance.Library });
	...
	/// <inheritdoc/>
        public override IReadOnlyList<Language> DependsOn => [LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.LibraryLanguage.Instance];
...
{
	private bool SetLibrariesRaw(List<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> nodes) => ExchangeChildrenRaw(nodes, _libraries);
	private bool AddLibrariesRaw(LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library? value) => AddChildRaw(value, _libraries);
	private bool InsertLibrariesRaw(int index, LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library? value) => InsertChildRaw(index, value, _libraries);
	private bool RemoveLibrariesRaw(LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library? value) => RemoveChildRaw(value, _libraries);
	private readonly List<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> _libraries = [];
	...
	/// <remarks>Required Multiple Containment</remarks>
        public bool TryGetLibraries([NotNullWhenAttribute(true)] out IReadOnlyList<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> libraries)
	{
        ...
        public Container AddLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> nodes)
	{
		...
		{
			ContainmentAddMultipleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> emitter = new(MultiLanguage.Instance.Container_libraries, this, safeNode, _libraries, null);
        ...
        public Container InsertLibraries(int index, IEnumerable<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> nodes)
	{
		...
		foreach (var safeNode in safeNodes)
		{
			ContainmentAddMultipleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> emitter = new(MultiLanguage.Instance.Container_libraries, this, safeNode, _libraries, index);
			emitter.CollectOldData();
        ...
        public Container RemoveLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> nodes)
	{
		...
		RemoveSelfParent(safeNodes, _libraries, MultiLanguage.Instance.Container_libraries, ContainmentRemover<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library>(MultiLanguage.Instance.Container_libraries));
		return this;
	}
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature))
		{
			...
			ContainmentSetNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library> emitter = new(MultiLanguage.Instance.Container_libraries, this, safeNodes, _libraries);
			emitter.CollectOldData();
			if (SetLibrariesRaw(safeNodes))
				emitter.Notify();
			return true;
		}
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			InsertLibraries(index, MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(link))
		{
			RemoveLibraries(MultiLanguage.Instance.Container_libraries.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library>(value));
			return true;
		}
        ...
        public override Containment? GetContainmentOf(INode child)
	{
		...
		if (result != null)
			return result;
		if (child is LionWeb.Core.Test.Languages.Generated.V2025_1.Library.M2.Library child0 && _libraries.Contains(child0))

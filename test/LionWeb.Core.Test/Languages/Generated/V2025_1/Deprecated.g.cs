...
public partial class DeprConcept : ConceptInstanceBase
{
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		{
			AddDeprChild(DeprecatedLanguage.Instance.DeprConcept_deprChild.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.DeprecatedLang.DeprIface>(nodes));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> nodes)
	{
		...
		if (DeprecatedLanguage.Instance.DeprConcept_deprChild.EqualsIdentity(link))
		{
			InsertDeprChild(index, DeprecatedLanguage.Instance.DeprConcept_deprChild.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.DeprecatedLang.DeprIface>(nodes));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> nodes)
	{
		...
		if (DeprecatedLanguage.Instance.DeprConcept_deprChild.EqualsIdentity(link))
		{
			RemoveDeprChild(DeprecatedLanguage.Instance.DeprConcept_deprChild.AsNodes<LionWeb.Core.Test.Languages.Generated.V2025_1.DeprecatedLang.DeprIface>(nodes));
			return true;
		}

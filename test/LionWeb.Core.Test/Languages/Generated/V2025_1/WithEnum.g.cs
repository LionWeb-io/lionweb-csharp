...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2025_1.WithEnum.M2;
using LionWeb.Core;
...
public partial class WithEnumLanguage : LanguageBase<IWithEnumFactory>
{
	...
	public WithEnumLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{
...
public partial class EnumHolder : ConceptInstanceBase
{
	...
	/// <remarks>Required Property</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public EnumHolder SetEnumValue(MyEnum value, INotificationId? eventId = null)
	{
		AssureNotNull(value, WithEnumLanguage.Instance.EnumHolder_enumValue);
		PropertyNotificationEmitter evt = new(WithEnumLanguage.Instance.EnumHolder_enumValue, this, value, _enumValue, eventId);
		evt.CollectOldData();
		_enumValue = value;
		evt.Notify();
		return this;

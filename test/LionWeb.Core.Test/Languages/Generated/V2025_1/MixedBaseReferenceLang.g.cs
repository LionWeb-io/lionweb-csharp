...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2025_1.Mixed.MixedBaseReferenceLang;
using LionWeb.Core;
...
public partial class MixedBaseReferenceLangLanguage : LanguageBase<IMixedBaseReferenceLangFactory>
{
	...
	public MixedBaseReferenceLangLanguage(string id) : base(id, LionWebVersions.v2025_1)
	{

...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        public LinkTestConcept SetContainment_0_1(LinkTestConcept? value)
	{
		...
		emitter.CollectOldData();
		SetContainment_0_1Raw(value);
        emitter.Notify();
		return this;
	}

    private void SetContainment_0_1Raw(LinkTestConcept? value)
    {
    ...
    private void SetContainment_0_nRaw(List<LinkTestConcept> nodes)
    {
        ...
        public LinkTestConcept AddContainment_0_n(IEnumerable<LinkTestConcept> nodes)
	{
		...
		foreach (var safeNode in safeNodes)
		{
			...
			emitter.CollectOldData();
            AddContainment_0_nRaw(safeNode);
			emitter.Notify();
		}
    ...
    private bool AddContainment_0_nRaw(LinkTestConcept? node)
    {
        if (node is null)
            return false;
        ...
        public LinkTestConcept InsertContainment_0_n(int index, IEnumerable<LinkTestConcept> nodes)
	{
        ...
        foreach (var safeNode in safeNodes)
        {
		    ...
		    emitter.CollectOldData();
		    InsertContainment_0_nRaw(index++, safeNode);
		    emitter.Notify();
        }
		return this;
	}

    private bool InsertContainment_0_nRaw(int index, LinkTestConcept node)
    {
        if (node is null || !IsInRange(index, _containment_0_n))
            return false;

        AttachChild(node);
        
        _containment_0_n.Insert(index, node);
    ...
    private bool RemoveContainment_0_nRaw(LinkTestConcept? node)
    {
        if (node is null)
            return false;
        
        SetParentNull(node);
        return _containment_0_n.Remove(node);
    }
        ...
        public LinkTestConcept SetContainment_1(LinkTestConcept value)
	{
		...
		emitter.CollectOldData();
		SetContainment_1Raw(value);
        emitter.Notify();
		return this;
	}

    private void SetContainment_1Raw(LinkTestConcept? value)
    {
    ...
    private void SetContainment_1_nRaw(List<LinkTestConcept> nodes)
    {
        ...
        public LinkTestConcept AddContainment_1_n(IEnumerable<LinkTestConcept> nodes)
	{
		...
		foreach (var safeNode in safeNodes)
		{
			...
			emitter.CollectOldData();
            AddContainment_1_nRaw(safeNode);
			emitter.Notify();
		}
    ...
    private bool AddContainment_1_nRaw(LinkTestConcept? node)
    {
        if (node is null)
            return false;
        ...
        public LinkTestConcept InsertContainment_1_n(int index, IEnumerable<LinkTestConcept> nodes)
	{
        ...
        foreach (var safeNode in safeNodes)
        {
		    ...
		    emitter.CollectOldData();
		    InsertContainment_1_nRaw(index++, safeNode);
		    emitter.Notify();
        }
		return this;
	}

    private bool InsertContainment_1_nRaw(int index, LinkTestConcept node)
    {
        if (node is null || !IsInRange(index, _containment_1_n))
            return false;

        AttachChild(node);
        
        _containment_1_n.Insert(index, node);
        return true;
    }
    ...
    private bool RemoveContainment_1_nRaw(LinkTestConcept? node)
    {
        if (node is null)
            return false;
        
        SetParentNull(node);
        return _containment_1_n.Remove(node);
    }
	...
	/// <remarks>Optional Multiple Reference</remarks>
        ...
        private void SetReference_0_nRaw(List<ReferenceTarget> targets)
        {
        ...
        public LinkTestConcept InsertReference_0_n(int index, IEnumerable<LinkTestConcept> nodes)
	{
        ...
        foreach (var safeNode in safeNodes)
        {
		    ...
		    emitter.CollectOldData();
		    InsertReference_0_nRaw(index++, safeNode);
		    emitter.Notify();
        }
		return this;
	}
    ...
    private bool RemoveReference_0_nRaw(ReferenceTarget target) =>
        RemoveAll([target], _reference_0_n);
	...
	/// <remarks>Required Multiple Reference</remarks>
        ...
        private void SetReference_1_nRaw(List<ReferenceTarget> targets)
        {
        ...
        public LinkTestConcept InsertReference_1_n(int index, IEnumerable<LinkTestConcept> nodes)
	{
        ...
        foreach (var safeNode in safeNodes)
        {
		    ...
		    emitter.CollectOldData();
		    InsertReference_1_nRaw(index, safeNode);
		    emitter.Notify();
        }
		return this;
	}
    ...
    private bool RemoveReference_1_nRaw(ReferenceTarget target) =>
        RemoveAll([target], _reference_1_n);
    ...
    protected internal override bool TryGetContainmentRaw(Feature containment, out IWritableNode? node)
    {
        if (base.TryGetContainmentRaw(containment, out node))
            return true;

        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(containment))
        {
            node = _containment_0_1;
            return true;
        }

        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1.EqualsIdentity(containment))
        {
            node = _containment_1;
            return true;
        }
    ...
    protected internal override bool TryGetContainmentsRaw(Feature containment, out IReadOnlyList<IWritableNode> nodes)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(containment))
        {
            nodes = _containment_0_n;
            return true;
        }

        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(containment))
        {
            nodes = _containment_1_n;
            return true;
        }
    ...
    protected internal override bool TryGetReferenceRaw(Feature reference, out IReferenceTarget? target)
    {
    ...
    protected internal override bool TryGetReferencesRaw(Feature reference, out IReadOnlyList<IReferenceTarget> targets)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(reference))
        {
            targets = _reference_0_n;
            return true;
        }

        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(reference))
        {
            targets = _reference_1_n;
            return true;
        }
    ...
    protected internal override bool SetContainmentRaw(Feature containment, IWritableNode? node)
    {
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(containment))
		{
			if (node is null or LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept)
			{
				SetContainment_0_1Raw((LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept?)node);
				return true;
			}
		}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1.EqualsIdentity(containment))
		{
			if (node is null or LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept)
			{
				SetContainment_1Raw((LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept?)node);
				return true;
			}
		}
    ...
    protected internal override bool AddContainmentsRaw(Feature containment, IWritableNode node)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(containment))
        {
            if (node is null or LinkTestConcept)
            {
                return AddContainment_0_nRaw((LinkTestConcept?)node);
            }
        }
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(containment))
        {
            if (node is null or LinkTestConcept)
            {
                return AddContainment_1_nRaw((LinkTestConcept?)node);
            }
        }
    ...
    protected internal override bool AddReferencesRaw(Feature reference, ReferenceTarget target)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(reference))
        {
                return AddReference_0_nRaw(target);
        }

        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(reference))
        {
                return AddReference_1_nRaw(target);
        }
    ...
    protected internal override bool InsertContainmentsRaw(Feature containment, Int32 index, IWritableNode node)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(containment))
        {
            if (node is LinkTestConcept v)
            {
                return InsertContainment_0_nRaw(index, v);
            }
        }
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(containment))
        {
            if (node is LinkTestConcept v)
            {
                return InsertContainment_1_nRaw(index, v);
            }
        }
    ...
    protected internal override bool InsertReferencesRaw(Feature reference, Int32 index, ReferenceTarget target)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(reference))
        {
                return InsertReference_0_nRaw(index, target);
        }

        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(reference))
        {
                return InsertReference_1_nRaw(index, target);
        }
    ...
    protected internal override bool RemoveContainmentsRaw(Feature containment, IWritableNode node)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(containment))
        {
            if (node is null or LinkTestConcept)
            {
                return RemoveContainment_0_nRaw((LinkTestConcept?)node);
            }
        }
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(containment))
        {
            if (node is null or LinkTestConcept)
            {
                return RemoveContainment_1_nRaw((LinkTestConcept?)node);
            }
        }
    ...
    protected internal override bool RemoveReferencesRaw(Feature reference, ReferenceTarget target)
    {
        ...
        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(reference))
        {
                return RemoveReference_0_nRaw(target);
        }

        if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(reference))
        {
                return RemoveReference_1_nRaw(target);
        }
...
/// <exception cref="InvalidValueException">If set to null</exception>
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
	...
	/// <remarks>Optional Multiple Containment</remarks>
        public bool TryGetLinks([NotNullWhenAttribute(true)] out IReadOnlyList<LinkTestConcept> contents)
	{
		contents = _links.AsReadOnly();
        ...
        public TestPartition AddLinks(IEnumerable<LinkTestConcept> nodes)
	{
		...
		foreach (var safeNode in safeNodes)
		{
			ContainmentAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(TestLanguageLanguage.Instance.TestPartition_contents, this, [safeNode], _links, null);
			emitter.CollectOldData();
            AddLinksRaw(safeNode);
			emitter.Notify();
		}
    ...
    private bool AddLinksRaw(LinkTestConcept node)
    {
        if (node is null)
            return false;
        ...
        public TestPartition InsertLinks(int index, IEnumerable<LinkTestConcept> nodes)
	{
        ...
        foreach (var safeNode in safeNodes)
        {
		    ContainmentAddMultipleNotificationEmitter<LinkTestConcept> emitter = new(TestLanguageLanguage.Instance.TestPartition_contents, this, [safeNode], _links, index);
		    emitter.CollectOldData();
            InsertLinksRaw(index, safeNode);
		    emitter.Notify();
        }
		return this;
	}

    private bool InsertLinksRaw(int index, LinkTestConcept node)
    {
        if (node is null || !IsInRange(index, _links))
            return false;

        AttachChild(node);
        
        _links.Insert(index, node);
	...
	{
		RemoveSelfParent(nodes?.ToList(), _links, TestLanguageLanguage.Instance.TestPartition_contents, ContainmentRemover<LinkTestConcept>(TestLanguageLanguage.Instance.TestPartition_contents));
		return this;
	}

    private bool RemoveLinksRaw(LinkTestConcept? node)
    {
        if (node is null)
            return false;
    ...
    protected internal override bool TryGetContainmentsRaw(Feature containment, out IReadOnlyList<IWritableNode> nodes)
    {
        ...
        if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(containment))
        {
            nodes = _links;
            return true;
        }
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept>(value).ToList();
			ContainmentSetNotificationEmitter<LinkTestConcept> emitter = new(TestLanguageLanguage.Instance.TestPartition_contents, this, safeNodes, _links, notificationId);
			emitter.CollectOldData();
			RemoveSelfParent(_links.ToList(), _links, TestLanguageLanguage.Instance.TestPartition_contents);
			_links.AddRange(SetSelfParent(safeNodes, TestLanguageLanguage.Instance.TestPartition_contents));
			emitter.Notify();
			return true;
		}
        ...
        protected override bool AddInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		{
			AddLinks(TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool InsertInternal(Link? link, int index, IEnumerable<IReadableNode> value)
	{
		...
		if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			InsertLinks(index, TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept>(value));
			return true;
		}
        ...
        protected override bool RemoveInternal(Link? link, IEnumerable<IReadableNode> value)
	{
		...
		if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(link))
		{
			RemoveLinks(TestLanguageLanguage.Instance.TestPartition_contents.AsNodes<LionWeb.Core.Test.Languages.Generated.V2024_1.TestLanguage.LinkTestConcept>(value));
			return true;
		}
    ...
    protected internal override bool RemoveContainmentsRaw(Feature containment, IWritableNode node)
    {
        ...
        if (TestLanguageLanguage.Instance.TestPartition_contents.EqualsIdentity(containment))
        {
            if (node is null or LinkTestConcept)
            {
                return RemoveLinksRaw((LinkTestConcept?) node);
            }
        }
        ...
        protected override bool DetachChild(INode child)
	{
		...
		{
			RemoveSelfParent(child, _links, TestLanguageLanguage.Instance.TestPartition_contents);
			return true;
		}

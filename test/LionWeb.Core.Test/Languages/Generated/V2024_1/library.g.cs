...
public partial class Book : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature))
		{
			...
			{
				SetType((LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.BookType?)value);
				return true;
			}
	...
	protected internal override bool SetPropertyRaw(Property feature, object? value)
	{
		...
		if (LibraryLanguage.Instance.Book_type.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.BookType)
			return SetTypeRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.BookType?)value);
		return false;
	}
...
public partial class Library : ConceptInstanceBase
{
	...
	protected internal override bool AddContainmentsRaw(Containment feature, IWritableNode? value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Book)
			return AddBooksRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Book?)value);
		return false;
	}
	...
	protected internal override bool InsertContainmentsRaw(Containment feature, int index, IWritableNode? value)
	{
		if (base.InsertContainmentsRaw(feature, index, value))
			return true;
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Book)
			return InsertBooksRaw(index, (LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Book?)value);
		return false;
	}
	...
	protected internal override bool RemoveContainmentsRaw(Containment feature, IWritableNode? value)
	{
		if (base.RemoveContainmentsRaw(feature, value))
			return true;
		if (LibraryLanguage.Instance.Library_books.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Book)
			return RemoveBooksRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Book?)value);
		return false;
	}

...
public partial class Container : ConceptInstanceBase
{
        ...
        public Container AddLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> nodes)
	{
		...
		{
			ContainmentAddMultipleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> emitter = new(MultiLanguage.Instance.Container_libraries, this, safeNode, _libraries, null);
        ...
        public Container InsertLibraries(int index, IEnumerable<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> nodes)
	{
		...
		foreach (var safeNode in safeNodes)
		{
			ContainmentAddMultipleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> emitter = new(MultiLanguage.Instance.Container_libraries, this, safeNode, _libraries, index);
			emitter.CollectOldData();
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature))
		{
			...
			ContainmentSetNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> emitter = new(MultiLanguage.Instance.Container_libraries, this, safeNodes, _libraries);
			emitter.CollectOldData();
	...
	protected internal override bool AddContainmentsRaw(Containment feature, IWritableNode? value)
	{
		if (base.AddContainmentsRaw(feature, value))
			return true;
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library)
			return AddLibrariesRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library?)value);
		return false;
	}
	...
	protected internal override bool InsertContainmentsRaw(Containment feature, int index, IWritableNode? value)
	{
		if (base.InsertContainmentsRaw(feature, index, value))
			return true;
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library)
			return InsertLibrariesRaw(index, (LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library?)value);
		return false;
	}
	...
	protected internal override bool RemoveContainmentsRaw(Containment feature, IWritableNode? value)
	{
		if (base.RemoveContainmentsRaw(feature, value))
			return true;
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature) && value is null or LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library)
			return RemoveLibrariesRaw((LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library?)value);
		return false;
	}

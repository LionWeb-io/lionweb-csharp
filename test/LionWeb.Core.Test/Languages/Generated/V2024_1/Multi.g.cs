...
public partial class Container : ConceptInstanceBase
{
	...
	/// <remarks>Required Multiple Containment</remarks>
        ...
        public Container AddLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> nodes, INotificationId? eventId = null)
	{
		var safeNodes = nodes?.ToList();
		AssureNonEmpty(safeNodes, _libraries, MultiLanguage.Instance.Container_libraries);
		ContainmentAddMultipleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> evt = new(MultiLanguage.Instance.Container_libraries, this, safeNodes, _libraries, null, eventId);
		evt.CollectOldData();
	...
	/// <remarks>Required Multiple Containment</remarks>
        ...
        public Container InsertLibraries(int index, IEnumerable<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> nodes, INotificationId? eventId = null)
	{
		AssureInRange(index, _libraries);
		var safeNodes = nodes?.ToList();
		AssureNonEmpty(safeNodes, _libraries, MultiLanguage.Instance.Container_libraries);
		AssureNoSelfMove(index, safeNodes, _libraries);
		ContainmentAddMultipleNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> evt = new(MultiLanguage.Instance.Container_libraries, this, safeNodes, _libraries, index, eventId);
		evt.CollectOldData();
	...
	/// <remarks>Required Multiple Containment</remarks>
        ...
        public Container RemoveLibraries(IEnumerable<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> nodes, INotificationId? eventId = null)
	{
		var safeNodes = nodes?.ToList();
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? eventId = null)
	{
		...
		if (MultiLanguage.Instance.Container_libraries.EqualsIdentity(feature))
		{
			...
			ContainmentSetNotificationEmitter<LionWeb.Core.Test.Languages.Generated.V2024_1.Library.M2.Library> evt = new(MultiLanguage.Instance.Container_libraries, this, safeNodes, _libraries, eventId);
			evt.CollectOldData();

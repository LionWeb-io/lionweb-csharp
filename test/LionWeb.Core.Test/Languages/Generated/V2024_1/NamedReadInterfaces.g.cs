...
#nullable enable
namespace LionWeb.Core.Test.Languages.Generated.V2024_1.NamedLangReadInterfaces;
using LionWeb.Core;
...
public partial class NamedReadInterfacesLanguage : LanguageBase<INamedReadInterfacesFactory>
{
	...
	public NamedReadInterfacesLanguage(string id) : base(id, LionWebVersions.v2024_1)
	{

...
public partial class AConcept : ConceptInstanceBase
{
	...
	/// bRef desc
    	...
    	/// <seealso cref = "AConcept.BRef"/>
    	/// <remarks>Optional Single Reference</remarks>
        public AConcept SetBRef(LionWeb.Core.Test.Languages.Generated.V2024_1.Circular.B.BConcept? value, IEventId? eventId = null)
	{
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (ALangLanguage.Instance.AConcept_BRef.EqualsIdentity(feature))
		{
			...
			{
				SetBRef((LionWeb.Core.Test.Languages.Generated.V2024_1.Circular.B.BConcept?)value, eventId);
				return true;
			}

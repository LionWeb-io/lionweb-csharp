...
public abstract partial class BaseConcept : ConceptInstanceBase, LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseContainmentLang.BaseContainmentIface, LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBasePropertyLang.BasePropertyIface, LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseReferenceLang.BaseReferenceIface
{
	...
	/// <remarks>Required Property</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public BaseConcept SetEnumProp(LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedDirectEnumLang.DirectEnum value, INotificationId? eventId = null)
	{
	...
	/// <remarks>Required Property</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public BaseConcept SetSdtProp(LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedDirectSdtLang.DirectSdt value, INotificationId? eventId = null)
	{
...
/// <remarks>Required Single Containment</remarks>
/// <exception cref="InvalidValueException">If set to null</exception>
 LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseContainmentLang.BaseContainmentIface LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseContainmentLang.BaseContainmentIface.SetCont(INode value, INotificationId? eventId = null) => SetCont(value);
	/// <remarks>Required Single Containment</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public BaseConcept SetCont(INode value, INotificationId? eventId = null)
	{
		...
		ContainmentSingleNotificationEmitter<INode> evt = new(LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseContainmentLang.MixedBaseContainmentLangLanguage.Instance.BaseContainmentIface_Cont, this, value, _cont, eventId);
		evt.CollectOldData();
		SetParentNull(_cont);
		AttachChild(value);
		_cont = value;
...
/// <remarks>Required Property</remarks>
/// <exception cref="InvalidValueException">If set to null</exception>
 LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBasePropertyLang.BasePropertyIface LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBasePropertyLang.BasePropertyIface.SetProp(string value, INotificationId? eventId = null) => SetProp(value);
	/// <remarks>Required Property</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public BaseConcept SetProp(string value, INotificationId? eventId = null)
	{
		...
		PropertyNotificationEmitter evt = new(LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBasePropertyLang.MixedBasePropertyLangLanguage.Instance.BasePropertyIface_Prop, this, value, _prop, eventId);
		evt.CollectOldData();
		_prop = value;
		evt.Notify();
		return this;
...
/// <remarks>Required Single Reference</remarks>
/// <exception cref="InvalidValueException">If set to null</exception>
 LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseReferenceLang.BaseReferenceIface LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseReferenceLang.BaseReferenceIface.SetRef(IReadableNode value, INotificationId? eventId = null) => SetRef(value);
	/// <remarks>Required Single Reference</remarks>
    	/// <exception cref = "InvalidValueException">If set to null</exception>
        public BaseConcept SetRef(IReadableNode value, INotificationId? eventId = null)
	{
		...
		ReferenceSingleNotificationEmitter evt = new(LionWeb.Core.Test.Languages.Generated.V2024_1.Mixed.MixedBaseReferenceLang.MixedBaseReferenceLangLanguage.Instance.BaseReferenceIface_Ref, this, value, _ref, eventId);
		evt.CollectOldData();
		_ref = value;
		evt.Notify();
		return this;

...
public class MigrationResultTests
{
    ...
    public void Validate_OutputNull_ChangedTrue()
    {
        ...
        Assert.ThrowsExactly<InvalidMigrationResultException>(() => new MigrationResult(true, output).Validate(input));
    }
    ...
    public void Validate_OutputNull_ChangedFalse()
    {
        ...
        Assert.ThrowsExactly<InvalidMigrationResultException>(() => new MigrationResult(false, output).Validate(input));
    }

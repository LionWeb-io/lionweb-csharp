...
public class ReferenceTests_Multiple_Optional_Listener
{
    ...
    public void Single_Add()
    {
        ...
        int events = 0;
        parent.Publisher.Subscribe<ReferenceAddedEvent>((_, args) =>
        {
            events++;
    ...
    public void Single_Remove_Empty()
    {
        ...
        int events = 0;
        parent.Publisher.Subscribe<ReferenceDeletedEvent>((_, _) => events++);
    ...
    public void Single_Remove_Only()
    {
        ...
        int events = 0;
        parent.Publisher.Subscribe<ReferenceDeletedEvent>((_, args) =>
        {
            events++;
            Assert.AreSame(parent, args.Parent);
            Assert.AreSame(ShapesLanguage.Instance.ReferenceGeometry_shapes, args.Reference);
    ...
    public void EmptyArray()
    {
        ...
        int events = 0;
        parent.Publisher.Subscribe<ReferenceAddedEvent>((_, _) => events++);

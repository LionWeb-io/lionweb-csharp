...
public class SetFeaturesTests
{
    ...
    public void ReferenceMultipleOptional_Add()
    {
        ...
        Assert.IsTrue(parent.AddReferencesRaw(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, [target]));
        Assert.IsTrue(parent.TryGetReferencesRaw(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n,
            out var result));
    ...
    public void ReferenceMultipleOptional_Set_Reflective()
    {
        ...
        var other = new LinkTestConcept("myId");
        var target = ReferenceTarget.FromNode(other);
        Assert.IsFalse(parent.SetReferenceRaw(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, target));
        Assert.IsTrue(parent.TryGetReferencesRaw(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n,
            out var result));
    ...
    [TestMethod]
    public void ReferenceMultipleOptional_Remove_OtherTarget()
    {
        var parent = new LinkTestConcept("g");
        var other = new LinkTestConcept("myId");
        var target = ReferenceTarget.FromNode(other);
    ...
    public void ReferenceMultipleOptional_RemovePart()
    {
        ...
        parent.AddReferencesRaw(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n,
            [ReferenceTarget.FromNode(valueA), ReferenceTarget.FromNode(valueB)]);
        parent.RemoveReferencesRaw(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n,
    ...
    public void ReferenceMultipleOptional_Reset_Reflective()
    {
        ...
        Assert.IsFalse(parent.SetReferenceRaw(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n,

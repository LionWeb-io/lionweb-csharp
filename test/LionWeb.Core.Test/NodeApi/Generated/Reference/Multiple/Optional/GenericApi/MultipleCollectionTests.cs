...
public class MultipleCollectionTests
{
    ...
    public void Array()
    {
        ...
        parent.Add(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, values);
    ...
    public void Insert_ListMatchingType()
    {
        ...
        parent.Insert(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, 0, values);
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
    ...
    public void Insert_One_Before()
    {
        ...
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
        CollectionAssert.AreEqual(new List<LinkTestConcept> { valueA, valueB, circle }, parent.Reference_0_n.ToList());
    }
    ...
    public void Insert_One_After()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Insert(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, 1, values);
        Assert.IsNull(circle.GetParent());
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
        CollectionAssert.AreEqual(new List<LinkTestConcept> { circle, valueA, valueB }, parent.Reference_0_n.ToList());
    }
    ...
    public void Insert_Two_Before()
    {
        ...
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
        CollectionAssert.AreEqual(new List<LinkTestConcept> { valueA, valueB, circleA, circleB }, parent.Reference_0_n.ToList());
    }
    ...
    public void Insert_Two_Between()
    {
        ...
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
        CollectionAssert.AreEqual(new List<LinkTestConcept> { circleA, valueA, valueB, circleB }, parent.Reference_0_n.ToList());
    }
    ...
    public void Insert_Two_After()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Insert(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, 2, values);
        Assert.IsNull(circleA.GetParent());
        Assert.IsNull(circleB.GetParent());
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
        CollectionAssert.AreEqual(new List<LinkTestConcept> { circleA, circleB, valueA, valueB }, parent.Reference_0_n.ToList());
    }
    ...
    public void Remove_ListMatchingType()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new List<LinkTestConcept> { valueA, valueB };
        parent.Remove(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, values);
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
    ...
    public void Remove_HalfContained()
    {
        ...
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(circleA.GetParent());
        CollectionAssert.AreEqual(new List<LinkTestConcept> { circleB }, parent.Reference_0_n.ToList());
    }

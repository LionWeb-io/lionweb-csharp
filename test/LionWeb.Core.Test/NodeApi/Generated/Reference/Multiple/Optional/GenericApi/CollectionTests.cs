...
public class CollectionTests
{
    ...
    public void NullArray()
    {
        ...
        Assert.ThrowsExactly<InvalidValueException>(() => parent.Add(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, values));
        Assert.IsTrue(parent.Reference_0_n.Count == 0);
    }
    ...
    public void Insert_NullArray()
    {
        var parent = new LinkTestConcept("g");
        var values = new LinkTestConcept[] { null };
        Assert.ThrowsExactly<InvalidValueException>(() => parent.Insert(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, 0, values));
        Assert.IsTrue(parent.Reference_0_n.Count == 0);
    }
    ...
    public void Remove_NullArray()
    {
        var parent = new LinkTestConcept("g");
        var values = new LinkTestConcept[] { null };
        Assert.ThrowsExactly<InvalidValueException>(() => parent.Remove(TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n, values));
        Assert.IsTrue(parent.Reference_0_n.Count == 0);
    }

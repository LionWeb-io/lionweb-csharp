...
public class MultipleCollectionTests
{
    ...
    public void Result_Reflective()
    {
        ...
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Set(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values);
        var result = parent.Get(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n);
    ...
    {
        var parent = new LinkTestConcept("g");
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Get(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n));
    }
}
...
public class CollectionTests
{
    ...
    public void EmptyArray()
    {
        ...
        Assert.ThrowsExactly<InvalidValueException>(() => parent.AddReference_1_n(values));
    ...
    public void EmptyArray_Reflective()
    {
        ...
        Assert.ThrowsExactly<InvalidValueException>(
            () => parent.Set(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values));
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Reference_1_n.Count == 0);
    }
    ...
    {
        var values = new LinkTestConcept[0];
        Assert.ThrowsExactly<InvalidValueException>(() => new LinkTestConcept("cs") { Reference_1_n = values });
    }
    ...
    public void Insert_EmptyArray()
    {
        var parent = new LinkTestConcept("cs");
        var values = new LinkTestConcept[0];
        Assert.ThrowsExactly<InvalidValueException>(() => parent.InsertReference_1_n(0, values));
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Reference_1_n.Count == 0);
    }
    ...
    public void Remove_EmptyArray()
    {
        var parent = new LinkTestConcept("cs");
        var values = new LinkTestConcept[0];
        Assert.ThrowsExactly<InvalidValueException>(() => parent.RemoveReference_1_n(values));
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Reference_1_n.Count == 0);
    }
    ...
    public void EmptyList_Reset_Reflective()
    {
        ...
        parent.AddReference_1_n([value]);
        var values = new List<DataTypeTestConcept>();
        Assert.ThrowsExactly<InvalidValueException>(
            () => parent.Set(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values));
        CollectionAssert.AreEqual(new List<LinkTestConcept> { value }, parent.Reference_1_n.ToList());
    }
    ...
    public void SingleArray()
    {
        ...
        parent.AddReference_1_n(values);
    ...
    public void SingleArray_Constructor()
    {
        var value = new LinkTestConcept("s");
        var values = new LinkTestConcept[] { value };
        var parent = new LinkTestConcept("cs") { Reference_1_n = values };
        Assert.IsNull(value.GetParent());
        Assert.IsTrue(parent.Reference_1_n.Contains(value));
    }
    ...
    public void SingleArray_Remove_First()
    {
        ...
        var values = new LinkTestConcept[] { line };
        parent.RemoveReference_1_n(values);
        Assert.IsNull(circle.GetParent());
        Assert.IsNull(line.GetParent());

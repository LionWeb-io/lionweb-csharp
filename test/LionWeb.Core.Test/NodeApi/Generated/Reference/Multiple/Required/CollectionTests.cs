...
public class CollectionTests
{
    ...
    public void EmptyArray()
    {
        ...
        Assert.ThrowsExactly<InvalidValueException>(() => parent.AddMaterials(values));
    ...
    {
        var values = new IShape[0];
        Assert.ThrowsExactly<InvalidValueException>(() => new MaterialGroup("cs") { Materials = values });
    }
    ...
    public void Insert_EmptyArray()
    {
        var parent = new MaterialGroup("cs");
        var values = new IShape[0];
        Assert.ThrowsExactly<InvalidValueException>(() => parent.InsertMaterials(0, values));
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Materials.Count == 0);
    }

...
public class MultipleCollectionTests
{
    ...
    public void Insert_One_After()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Insert(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, 1, values);
        Assert.IsNull(circle.GetParent());
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
    ...
    public void Insert_Two_After()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Insert(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, 2, values);
        Assert.IsNull(circleA.GetParent());
        Assert.IsNull(circleB.GetParent());
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
    ...
    public void Remove_ListMatchingType()
    {
        ...
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Reference_1_n.Contains(valueA));
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Reference_1_n.Contains(valueB));
    }
    ...
    public void Remove_Only()
    {
        var valueA = new LinkTestConcept("sA");
        var valueB = new LinkTestConcept("sB");
        var parent = new LinkTestConcept("cs") { Reference_1_n = [valueA, valueB] };
        var values = new LinkTestConcept[] { valueA, valueB };
        Assert.ThrowsExactly<InvalidValueException>(() => parent.Remove(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values));
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
    ...
    public void Remove_First()
    {
        ...
        var valueA = new LinkTestConcept("sA");
        var valueB = new LinkTestConcept("sB");
        var parent = new LinkTestConcept("cs") { Reference_1_n = [valueA, valueB, circle] };
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Remove(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values);
        Assert.IsNull(circle.GetParent());
        Assert.IsNull(valueA.GetParent());
    ...
    public void Remove_Last()
    {
        ...
        var valueA = new LinkTestConcept("sA");
        var valueB = new LinkTestConcept("sB");
        var parent = new LinkTestConcept("cs") { Reference_1_n = [circle, valueA, valueB] };
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Remove(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values);
        Assert.IsNull(circle.GetParent());
        Assert.IsNull(valueA.GetParent());
    ...
    public void Remove_Between()
    {
        ...
        var valueA = new LinkTestConcept("sA");
        var valueB = new LinkTestConcept("sB");
        var parent = new LinkTestConcept("cs") { Reference_1_n = [circleA, valueA, valueB, circleB] };
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Remove(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values);
        Assert.IsNull(circleA.GetParent());
        Assert.IsNull(circleB.GetParent());
    ...
    public void Remove_Mixed()
    {
        ...
        var valueA = new LinkTestConcept("sA");
        var valueB = new LinkTestConcept("sB");
        var parent = new LinkTestConcept("cs") { Reference_1_n = [valueA, circleA, valueB, circleB] };
        var values = new LinkTestConcept[] { valueA, valueB };
        parent.Remove(TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n, values);
        Assert.IsNull(circleA.GetParent());
        Assert.IsNull(circleB.GetParent());

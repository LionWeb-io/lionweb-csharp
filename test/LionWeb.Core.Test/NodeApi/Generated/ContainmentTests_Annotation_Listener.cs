...
public class ContainmentTests_Annotation_Listener
{
    ...
    public void Single_Add()
    {
        ...
        int events = 0;
        parent.GetPublisher().Subscribe<AnnotationAddedNotification>((_, args) =>
        {
            events++;
    ...
    public void Single_Add_FromOtherParent()
    {
        ...
        int events = 0;
        parent.GetPublisher().Subscribe<AnnotationMovedFromOtherParentNotification>((_, args) =>
        {
            events++;
    ...
    public void Single_Add_FromSameParent()
    {
        ...
        int events = 0;
        parent.GetPublisher().Subscribe<AnnotationMovedInSameParentNotification>((_, args) =>
        {
            events++;
    ...
    public void Single_Add_FromSameParent_NoOp()
    {
        ...
        int events = 0;
        parent.GetPublisher().Subscribe<AnnotationMovedInSameParentNotification>((_, _) => events++);
    ...
    public void Single_Remove_Empty()
    {
        ...
        int events = 0;
        parent.GetPublisher().Subscribe<AnnotationDeletedNotification>((_, _) => events++);
    ...
    public void Single_Remove_Only()
    {
        ...
        int events = 0;
        parent.GetPublisher().Subscribe<AnnotationDeletedNotification>((_, args) =>
        {
            events++;
            Assert.AreSame(line, args.Parent);
            Assert.AreEqual(0, args.Index);
    ...
    public void EmptyArray()
    {
        ...
        int events = 0;
        parent.GetPublisher().Subscribe<AnnotationAddedNotification>((_, _) => events++);

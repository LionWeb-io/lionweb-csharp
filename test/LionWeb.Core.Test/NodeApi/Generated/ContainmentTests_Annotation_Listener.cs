...
public class ContainmentTests_Annotation_Listener
{
    ...
    public void Single_Add()
    {
        ...
        int events = 0;
        ((IPartitionInstance)parent).Listener.AnnotationAdded += (sender, args) =>
        {
            events++;
    ...
    public void Single_Add_FromOtherParent()
    {
        ...
        int events = 0;
        ((IPartitionInstance)parent).Listener.AnnotationMovedFromOtherParent += (sender, args) =>
        {
            events++;
    ...
    public void Single_Add_FromSameParent()
    {
        ...
        int events = 0;
        ((IPartitionInstance)parent).Listener.AnnotationMovedInSameParent += (sender, args) =>
        {
            events++;
    ...
    public void Single_Remove_Empty()
    {
        ...
        int events = 0;
        ((IPartitionInstance)parent).Listener.AnnotationDeleted += (sender, args) =>
        {
            events++;
        };

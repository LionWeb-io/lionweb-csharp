...
public class CollectionTests
{
    ...
    public void EmptyArray()
    {
        ...
        Assert.ThrowsExactly<InvalidValueException>(() => parent.Add(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, values));
    ...
    public void Insert_EmptyArray()
    {
        var parent = new LinkTestConcept("cs");
        var values = new LinkTestConcept[0];
        Assert.ThrowsExactly<InvalidValueException>(() => parent.Insert(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, 0, values));
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Containment_1_n.Count == 0);
    }

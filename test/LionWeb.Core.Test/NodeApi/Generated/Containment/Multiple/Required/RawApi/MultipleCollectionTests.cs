...
public class MultipleCollectionTests
{
    ...
    public void List()
    {
        ...
        Assert.IsTrue(parent.AddRaw(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, values));
    ...
    public void Insert_ListMatchingType()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new List<INode> { valueA, valueB };
        Assert.IsTrue(parent.InsertRaw(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, 0, values));
        Assert.AreSame(parent, valueA.GetParent());
        Assert.AreSame(parent, valueB.GetParent());
        CollectionAssert.AreEqual(new List<INode> { valueA, valueB }, parent.Containment_1_n.ToList());
    }
    ...
    public void Insert_One_Before()
    {
        ...
        Assert.AreSame(parent, valueA.GetParent());
        Assert.AreSame(parent, valueB.GetParent());
        CollectionAssert.AreEqual(new List<INode> { valueA, valueB, circle }, parent.Containment_1_n.ToList());
    }
    ...
    public void Insert_One_After()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new List<INode> { valueA, valueB };
        Assert.IsTrue(parent.InsertRaw(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, 1, values));
        Assert.AreSame(parent, circle.GetParent());
        Assert.AreSame(parent, valueA.GetParent());
        Assert.AreSame(parent, valueB.GetParent());
        CollectionAssert.AreEqual(new List<INode> { circle, valueA, valueB }, parent.Containment_1_n.ToList());
    }
    ...
    public void Insert_Two_Before()
    {
        ...
        Assert.AreSame(parent, valueA.GetParent());
        Assert.AreSame(parent, valueB.GetParent());
        CollectionAssert.AreEqual(new List<INode> { valueA, valueB, circleA, circleB }, parent.Containment_1_n.ToList());
    }
    ...
    public void Insert_Two_Between()
    {
        ...
        Assert.AreSame(parent, valueA.GetParent());
        Assert.AreSame(parent, valueB.GetParent());
        CollectionAssert.AreEqual(new List<INode> { circleA, valueA, valueB, circleB }, parent.Containment_1_n.ToList());
    }
    ...
    public void Insert_Two_After()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new List<INode> { valueA, valueB };
        Assert.IsTrue(parent.InsertRaw(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, 2, values));
        Assert.AreSame(parent, circleA.GetParent());
        Assert.AreSame(parent, circleB.GetParent());
        Assert.AreSame(parent, valueA.GetParent());
        Assert.AreSame(parent, valueB.GetParent());
        CollectionAssert.AreEqual(new List<INode> { circleA, circleB, valueA, valueB }, parent.Containment_1_n.ToList());
    }
    ...
    public void Remove_ListMatchingType()
    {
        ...
        var valueB = new LinkTestConcept("sB");
        var values = new List<INode> { valueA, valueB };
        Assert.IsFalse(parent.RemoveRaw(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, values));
    ...
    public void Remove_Only()
    {
        ...
        var values = new List<INode> { valueA, valueB };
        Assert.IsTrue(parent.RemoveRaw(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, values));
        Assert.IsNull(valueA.GetParent());
        Assert.IsNull(valueB.GetParent());
        Assert.ThrowsExactly<UnsetFeatureException>(() => parent.Containment_1_n.Contains(valueA));
    }
    ...
    public void Remove_HalfContained()
    {
        ...
        CollectionAssert.AreEqual(new List<INode> { circleB }, parent.Containment_1_n.ToList());
    }
    ...
    public void Remove_Last()
    {
        ...
        var values = new List<INode> { circle, valueA, valueB };
        Assert.IsTrue(parent.RemoveRaw(TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n, values));

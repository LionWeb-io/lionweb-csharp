...
[TestClass]
public class MultipleOptionalTests : LenientNodeTestsBase
{
    #region singleEntry
    ...
    public void MultipleOptional_Single_OtherInSameInstance_Reflective()
    {
        ...
        parent.Set(BillOfMaterials_altGroups, new List<LenientNode> { child });

        Assert.AreSame(parent, child.GetParent());
        CollectionAssert.AreEqual(new List<LenientNode> { child }, parent.Get(BillOfMaterials_altGroups) as IList);
    ...
    public void MultipleOptional_Single_SameInSameInstance_Reflective()
    {
        ...
        parent.Set(BillOfMaterials_groups, new List<LenientNode> { child });

        Assert.AreSame(parent, child.GetParent());
        CollectionAssert.AreEqual(new List<LenientNode> { child }, parent.Get(BillOfMaterials_groups) as IList);
    }
    ...
    public void MultipleOptional_Partial_SameInOtherInstance_Reflective()
    {
        ...
        CollectionAssert.AreEqual(new List<LenientNode> { childB }, source.Get(Geometry_shapes) as IList);
    }
    ...
    public void MultipleOptional_Partial_OtherInSameInstance_Reflective()
    {
        ...
        parent.Set(BillOfMaterials_altGroups, new List<LenientNode> { childA });

        Assert.AreSame(parent, childA.GetParent());
        CollectionAssert.AreEqual(new List<LenientNode> { childA }, parent.Get(BillOfMaterials_altGroups) as IList);
        CollectionAssert.AreEqual(new List<LenientNode> { childB }, parent.Get(BillOfMaterials_groups) as IList);
    }
    ...
    public void MultipleOptional_Partial_SameInSameInstance_Reflective()
    {
        ...
        parent.Set(BillOfMaterials_groups, new List<LenientNode> { childA });

        Assert.AreSame(parent, childA.GetParent());
        CollectionAssert.AreEqual(new List<LenientNode> { childA }, parent.Get(BillOfMaterials_groups) as IList);
    }

...
public class TestLanguagesDefinitions
{
    ...
    public Dictionary<PrimitiveType, Type> CustomPrimitiveTypeMapping { get; private set; } = [];
    ...
    private void CreateCustomPrimitiveTypeLang()
    {
        ...
        CustomType(typeof(LionWeb.Build.Languages.SubNamespace.CustomType), "CustomNestedType");
        CustomType(typeof(CustomEnumType));
        ...
        CustomType(typeof(bool), "Bool");
        CustomType(typeof(bool), "Boolean");
        
        CustomPrimitiveTypeLang = lang;
        return;

        void CustomType(Type type, string? name = null)
        {

...
public static class ShapesDefinition
{
    ...
    /// </summary>
    public static readonly DynamicLanguage Language = new("id-Shapes")
    {
    ...
    static ShapesDefinition()
    {
        ...
        Circle.Property("id-r", "key-r", "r").OfType(BuiltInsLanguage.Instance.Integer);
        Circle.Containment("id-center", "key-center", "center").OfType(Coord);

        Coord.Property("id-x", "key-x", "x").OfType(BuiltInsLanguage.Instance.Integer);
        Coord.Property("id-y", "key-y", "y").OfType(BuiltInsLanguage.Instance.Integer);
        Coord.Property("id-z", "key-z", "z").OfType(BuiltInsLanguage.Instance.Integer);
        ...
        Line.Implementing(BuiltInsLanguage.Instance.INamed);
        ...
        OffsetDuplicate.Containment("id-secret-docs", "key-secret-docs", "secretDocs").IsOptional().OfType(Documentation);

        Shape.IsAbstract().Implementing(BuiltInsLanguage.Instance.INamed, IShape);
        ...
        IShape.Property("id-uuid", "key-uuid", "uuid").OfType(BuiltInsLanguage.Instance.String);
        ...
        CompositeShape.Containment("id-disabled-parts", "key-disabled-parts", "disabledParts").OfType(IShape).IsMultiple();
        CompositeShape.Containment("id-evil-part", "key-evil-part", "evilPart").OfType(IShape);

        Documentation.Property("id-text", "key-text", "text").OfType(BuiltInsLanguage.Instance.String).IsOptional();
        Documentation.Property("id-technical", "key-technical", "technical").OfType(BuiltInsLanguage.Instance.Boolean)
            .IsOptional();
        ...
        BillOfMaterials.Containment("id-alt-groups", "key-alt-groups", "altGroups").OfType(MaterialGroup).IsMultiple()
            .IsOptional();
        BillOfMaterials.Containment("id-default-group", "key-default-group", "defaultGroup").OfType(MaterialGroup).IsOptional();
        BillOfMaterials.Annotating(BuiltInsLanguage.Instance.Node);
